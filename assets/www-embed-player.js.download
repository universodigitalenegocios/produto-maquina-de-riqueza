...
c.prototype=b.prototype;a.aa=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.po=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;function fd(a){this.i=!1;var b=a.program;a=a.globalName;var c=new ed;this.j=c.promise;this.l=q((0,x[a].a)(b,function(d,e){Promise.resolve().then(function(){c.resolve({Ob:d,wc:e})})},!0)).next().value;
this.vc=c.promise.then(function(){})}
fd.prototype.snapshot=function(a){if(this.i)throw Error("Already disposed");return this.j.then(function(b){var c=b.Ob;return new Promise(function(d){c(function(e){d(e)},[a.qb,
a.xc])})})};
fd.prototype.Jb=function(a){if(this.i)throw Error("Already disposed");return this.l([a.qb,a.xc])};
fd.prototype.dispose=function(){this.i=!0;this.j.then(function(a){(a=a.wc)&&a()})};
...
return a}
var td={Mc:"allow-forms",Nc:"allow-modals",Oc:"allow-orientation-lock",Pc:"allow-pointer-lock",Qc:"allow-popups",Rc:"allow-popups-to-escape-sandbox",Sc:"allow-presentation",Tc:"allow-same-origin",Uc:"allow-scripts",Vc:"allow-top-navigation",Wc:"allow-top-navigation-by-user-activation"},vd=bb(function(){return ud()});
...
function Id(a){var b=Fd();b.update(a);return b.Sb().toLowerCase()}
...
function Wd(a,b){b||(b={});b[Yd(a)]=!0;var c=a.stack||"";(a=a.Pb)&&!b[Yd(a)]&&(c+="\nCaused by: ",a.stack&&0==a.stack.indexOf(a.toString())||(c+="string"===typeof a?a:a.message+"\n"),c+=Wd(a,b));return c}
...
;var Ce={Wn:"WEB_DISPLAY_MODE_UNKNOWN",Sn:"WEB_DISPLAY_MODE_BROWSER",Un:"WEB_DISPLAY_MODE_MINIMAL_UI",Vn:"WEB_DISPLAY_MODE_STANDALONE",Tn:"WEB_DISPLAY_MODE_FULLSCREEN"};function De(){this.data_=[];this.h=-1}
...
r(vg,I);var wg={rh:0,bh:1,ih:2,jh:4,oh:8,kh:16,lh:32,qh:64,ph:128,eh:256,gh:512,nh:1024,fh:2048,hh:4096,dh:8192,mh:16384};function xg(a){I.call(this,a)}
...
r(Wg,I);var Xg;Xg=new function(a,b,c,d){this.h=a;this.fieldName=b;this.isRepeated=d;this.i=bd}(406606992,{to:0},Wg,0);function Yg(){Wg.apply(this,arguments)}
...
function Th(a){var b=void 0===a?{}:a;a=void 0===b.fc?!1:b.fc;b=void 0===b.Ub?!0:b.Ub;if(null==A("_lact",window)){var c=parseInt(B("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Uh();Eh(document,"keydown",Uh);Eh(document,"keyup",Uh);Eh(document,"mousedown",Uh);Eh(document,"mouseup",Uh);a?Eh(window,"touchmove",function(){Vh("touchmove",200)},{passive:!0}):(Eh(window,"resize",function(){Vh("resize",200)}),b&&Eh(window,"scroll",function(){Vh("scroll",200)}));
...
function mj(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Bb:a,xa:b,qo:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
function sj(a,b,c,d){d=void 0===d?{}:d;if(L("lr_drop_other_and_business_payloads")){if(qh[a]||ph[a])return}else if(L("lr_drop_other_payloads")&&qh[a])return;var e={},f=Math.round(d.timestamp||M());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=Wh();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};L("log_sequence_info_on_gel_web")&&d.X&&(a=e.context,b=d.X,b={index:tj(b),groupKey:b},a.sequence=b,d.ub&&delete rj[d.X]);(d.nc?cj:Xi)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,
xa:d.xa},c)}
...
function nj(a){var b=new tg,c=new mg;G(c,1,a.yb);G(c,2,a.xb);G(c,16,a.Wb);G(c,17,a.innertubeContextClientVersion);if(a.cb){var d=a.cb,e=new jg;d.coldConfigData&&G(e,1,d.coldConfigData);d.appInstallData&&G(e,6,d.appInstallData);d.coldHashData&&G(e,3,d.coldHashData);d.hotHashData&&G(e,5,d.hotHashData);H(c,62,e)}(d=x.devicePixelRatio)&&1!=d&&G(c,65,d);d=nh();""!==d&&G(c,54,d);d=oh();if(0<d.length){e=new og;for(var f=0;f<d.length;f++){var g=new hg;G(g,1,d[f].key);g.setValue(d[f].value);Pc(e,15,hg,g)}H(b,
...
function Tj(a,b,c){c=void 0===c?{}:c;var d={};L("enable_web_eom_visitor_data")&&B("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":B("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||B("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.oo||B("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().no:b=Qd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=B("SESSION_INDEX",0),L("pageid_as_header_web")&&(d["X-Goog-PageId"]=B("DELEGATED_SESSION_ID")));return d}
...
closed:b,zc:b,upgrade:this.options.upgrade};return this.h=d=a()};var ml=new jl("YtIdbMeta",{za:{databases:{Xa:1}},upgrade:function(a,b){b(1)&&Tk(a,"databases",{keyPath:"actualName"})}});
...
function Jl(a){a.v&&!a.ya&&(a.h=!0,a.Ma&&Math.random()<=a.La&&a.J.Qb(a.v),Kl(a),a.I.G()&&a.Ca(),a.B&&!a.B("use_new_nwl_initialization")&&(a.I.W(a.ib,a.Ca.bind(a)),a.I.W(a.hb,a.nb.bind(a))))}
...
l.Ca=function(){var a=this;if(!this.v)throw Ek("throttleSend");this.i||(this.i=this.V.M(function(){var b;return w(function(c){if(1==c.h)return u(c,a.J.wb("NEW",a.v),2);if(3!=c.h)return b=c.i,b?u(c,Ll(a,b),3):(a.nb(),c.return());a.i&&(a.i=0,a.Ca());c.h=0})},this.Kb))};
...
function Ml(a,b){a.Lb&&!a.I.G()?a.Lb(b):a.handleError(b)}
...
l.cc=function(a){!L("use_shared_nsm")&&(this.m=!0,void 0===a?0:a)&&(this.L||Jm(this))};
...
;var Mm;function Nm(){Il.call(this,{J:{Qb:om,ra:nm,wb:km,ac:lm,jb:mm,set:im},I:Om(),handleError:wh,sa:xh,ea:Pm,now:M,Lb:Dm,V:Qh(),ib:"publicytnetworkstatus-online",hb:"publicytnetworkstatus-offline",Ma:!0,La:.1,Sa:mh("potential_esf_error_limit",10),B:L,ya:!pk()});this.j=new ed;L("networkless_immediately_drop_all_requests")&&pm();Hl("LogsDatabaseV2")}
r(Nm,Il);function Qm(){var a=A("yt.networklessRequestController.instance");a||(a=new Nm,y("yt.networklessRequestController.instance",a,void 0),L("networkless_logging")&&xl().then(function(b){a.v=b;Jl(a);a.j.resolve();a.Ma&&Math.random()<=a.La&&a.v&&tm(a.v);L("networkless_immediately_drop_sw_health_store")&&Rm(a)}));
return a}
...
function Rm(a){var b;w(function(c){if(!a.v)throw b=Ek("clearSWHealthLogsDb"),b;return c.return(um(a.v).catch(function(d){a.handleError(d)}))})}
function Pm(a,b,c){L("use_cfr_monitor")&&Sm(a,b);var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(M());c&&0===Object.keys(b).length?xm(a):ti(a,b)}
...
;var Tm=!1,Um=0,Vm=0,Wm,Xm=x.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:Tm,potentialEsfErrorCounter:Vm};y("ytNetworklessLoggingInitializationOptions",Xm,void 0);
function Ym(){var a;w(function(b){switch(b.h){case 1:return u(b,xl(),2);case 2:a=b.i;if(!a||!pk()&&!L("nwl_init_require_datasync_id_killswitch")){b.s(0);break}Tm=!0;Xm.isNwlInitialized=Tm;if(!L("use_new_nwl_initialization")){b.s(4);break}return u(b,Qm().awaitInitialization(),5);case 5:return Zm().W("publicytnetworkstatus-online",$m),Zm().W("publicytnetworkstatus-offline",an),b.return();case 4:return u(b,Hl("LogsDatabaseV2"),6);case 6:if(!(.1>=Math.random())){b.s(7);break}return u(b,om(a),8);case 8:return u(b,
tm(a),7);case 7:bn();Zm().G()&&$m();Zm().W("publicytnetworkstatus-online",$m);Zm().W("publicytnetworkstatus-offline",an);if(!L("networkless_immediately_drop_sw_health_store")){b.s(10);break}return u(b,cn(),10);case 10:if(L("networkless_immediately_drop_all_requests"))return u(b,pm(),0);b.s(0)}})}
function dn(a,b){function c(d){var e=Zm().G();if(!en()||!d||e&&L("vss_networkless_bypass_write"))fn(a,b);else{var f={url:a,options:b,timestamp:M(),status:"NEW",sendCount:0};im(f,d).then(function(g){f.id=g;Zm().G()&&gn(f)}).catch(function(g){gn(f);
Zm().G()?wh(g):Dm(g)})}}
b=void 0===b?{}:b;L("skip_is_supported_killswitch")?xl().then(function(d){c(d)}):c(wl())}
function hn(a,b){function c(d){if(en()&&d){var e={url:a,options:b,timestamp:M(),status:"NEW",sendCount:0},f=!1,g=b.onSuccess?b.onSuccess:function(){};
e.options.onSuccess=function(k,m){L("use_cfr_monitor")&&Am().requestComplete(e.url,!0);void 0!==e.id?nm(e.id,d):f=!0;L("vss_network_hint")&&Zm().ca(!0);g(k,m)};
if(L("use_cfr_monitor")){var h=b.onError?b.onError:function(){};
e.options.onError=function(k,m){Am().requestComplete(e.url,!1);h(k,m)}}fn(e.url,e.options);
im(e,d).then(function(k){e.id=k;f&&nm(e.id,d)}).catch(function(k){Zm().G()?wh(k):Dm(k)})}else fn(a,b)}
b=void 0===b?{}:b;L("skip_is_supported_killswitch")?xl().then(function(d){c(d)}):c(wl())}
function $m(){var a=wl();if(!a)throw Ek("throttleSend");Um||(Um=Rh.M(function(){var b;return w(function(c){if(1==c.h)return u(c,km("NEW",a),2);if(3!=c.h)return b=c.i,b?u(c,gn(b),3):(an(),c.return());Um&&(Um=0,$m());c.h=0})},100))}
function an(){Rh.U(Um);Um=0}
function gn(a){var b,c,d;return w(function(e){switch(e.h){case 1:b=wl();if(!b)throw c=Ek("immediateSend"),c;if(void 0===a.id){e.s(2);break}return u(e,lm(a.id,b),3);case 3:(d=e.i)?a=d:xh(Error("The request cannot be found in the database."));case 2:if(jn(a,2592E6)){e.s(4);break}xh(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.s(5);break}return u(e,nm(a.id,b),5);case 5:return e.return();case 4:a.skipRetry||(a=kn(a));var f=a,g,h;if(null==f?0:null==(g=f.options)?
0:null==(h=g.postParams)?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(M());a=f;if(!a){e.s(0);break}if(!a.skipRetry||void 0===a.id){e.s(8);break}return u(e,nm(a.id,b),8);case 8:fn(a.url,a.options,!!a.skipRetry),e.h=0}})}
function kn(a){var b=wl();if(!b)throw Ek("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.h){case 1:L("use_cfr_monitor")&&Am().requestComplete(a.url,!1);g=Pl(f);if(!(L("nwl_consider_error_code")&&g||!L("nwl_consider_error_code")&&ln()<=mh("potential_esf_error_limit",10))){m.s(2);break}if(L("skip_checking_network_on_cfr_failure")&&(!L("skip_checking_network_on_cfr_failure")||Am().isEndpointCFR(a.url))){m.s(3);break}return u(m,Zm().fa(),3);case 3:if(Zm().G()){m.s(2);break}c(e,f);if(!L("nwl_consider_error_code")||void 0===
(null==(h=a)?void 0:h.id)){m.s(6);break}return u(m,mm(a.id,b,!1),6);case 6:return m.return();case 2:if(L("nwl_consider_error_code")&&!g&&ln()>mh("potential_esf_error_limit",10))return m.return();A("ytNetworklessLoggingInitializationOptions")&&Xm.potentialEsfErrorCounter++;Vm++;if(void 0===(null==(k=a)?void 0:k.id)){m.s(8);break}return 1>a.sendCount?u(m,mm(a.id,b),12):u(m,nm(a.id,b),8);case 12:Rh.M(function(){Zm().G()&&$m()},5E3);
case 8:c(e,f),m.h=0}})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){var g;return w(function(h){if(1==h.h)return L("use_cfr_monitor")&&Am().requestComplete(a.url,!0),void 0===(null==(g=a)?void 0:g.id)?h.s(2):u(h,nm(a.id,b),2);L("vss_network_hint")&&Zm().ca(!0);d(e,f);h.h=0})};
return a}
function jn(a,b){a=a.timestamp;return M()-a>=b?!1:!0}
function bn(){var a=wl();if(!a)throw Ek("retryQueuedRequests");km("QUEUED",a).then(function(b){b&&!jn(b,12E4)?Rh.M(function(){return w(function(c){if(1==c.h)return void 0===b.id?c.s(2):u(c,mm(b.id,a),2);bn();c.h=0})}):Zm().G()&&$m()})}
function cn(){var a,b;return w(function(c){a=wl();if(!a)throw b=Ek("clearSWHealthLogsDb"),b;return c.return(um(a).catch(function(d){wh(d)}))})}
function Zm(){if(L("use_new_nwl"))return Om();Wm||(Wm=new Km({Pa:!0,tb:!0}));return Wm}
function fn(a,b,c){c&&0===Object.keys(b).length?xm(a):ti(a,b)}
function en(){return A("ytNetworklessLoggingInitializationOptions")?Xm.isNwlInitialized:Tm}
function ln(){return A("ytNetworklessLoggingInitializationOptions")?Xm.potentialEsfErrorCounter:Vm}
;function mn(a){var b=this;this.config_=null;a?this.config_=a:Nj()&&(this.config_=hj());Lh(function(){ak(b)},5E3)}
mn.prototype.isReady=function(){!this.config_&&Nj()&&(this.config_=hj());return!!this.config_};
...
Ra:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var pn={ia:[],ha:[{la:on,weight:500}]};function on(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function qn(){this.ha=[];this.ia=[]}
var rn;function sn(){if(!rn){var a=rn=new qn;a.ia.length=0;a.ha.length=0;pn.ia&&a.ia.push.apply(a.ia,pn.ia);pn.ha&&a.ha.push.apply(a.ha,pn.ha)}return rn}
;var tn=new K;function un(a){function b(){return a.charCodeAt(d++)}
...
;var zn=new Set,An=0,Bn=0,Cn=0,Dn=[],En=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function kk(a){Fn(a)}
function Gn(a){Fn(a,"WARNING")}
...
a.fileName),d.push("Stacktrace: "+a.stack),window.console.log(d.join("\n"),a)),!(5<=An))){d=Dn;var g=Vd(a);e=g.message||"Unknown Error";f=g.name||"UnknownError";var h=g.stack||a.i||"Not available";if(h.startsWith(f+": "+e)){var k=h.split("\n");k.shift();h=k.join("\n")}k=g.lineNumber||"Not available";g=g.fileName||"Not available";var m=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var n=0;n<a.args.length&&!(m=wn(a.args[n],"params."+n,c,m),500<=m);n++);else if(a.hasOwnProperty("params")&&
a.params){var t=a.params;if("object"===typeof a.params)for(n in t){if(t[n]){var z="params."+n,v=yn(t[n]);c[z]=v;m+=z.length+v.length;if(500<m)break}}else c.params=yn(t)}if(d.length)for(n=0;n<d.length&&!(m=wn(d[n],"params.context."+n,c,m),500<=m);n++);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c["device.vendor"]=navigator.vendor);n={message:e,name:f,lineNumber:k,fileName:g,stack:h,params:c,sampleWeight:1};c=Number(a.columnNumber);isNaN(c)||(n.lineNumber=n.lineNumber+":"+c);if("IGNORED"===a.level)a=
0;else a:{a=sn();c=q(a.ia);for(d=c.next();!d.done;d=c.next())if(d=d.value,n.message&&n.message.match(d.vo)){a=d.weight;break a}a=q(a.ha);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.la(n)){a=c.weight;break a}a=1}n.sampleWeight=a;a=q(nn);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ra[n.name])for(e=q(c.Ra[n.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=n.message.match(f.regexp)){n.params["params.error.original"]=d[0];e=f.groups;f={};for(k=0;k<e.length;k++)f[e[k]]=d[k+1],n.params["params.error."+
e[k]]=d[k+1];n.message=c.gb(f);break}n.params||(n.params={});a=sn();n.params["params.errorServiceSignature"]="msg="+a.ia.length+"&cb="+a.ha.length;n.params["params.serviceWorker"]="false";x.document&&x.document.querySelectorAll&&(n.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Ab("sample").constructor!==yb&&(n.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(n);if(0!==n.sampleWeight&&!zn.has(n.message)){"ERROR"===
b?(tn.ka("handleError",n),L("record_app_crashed_web")&&0===Cn&&1===n.sampleWeight&&(Cn++,a={appCrashType:"APP_CRASH_TYPE_BREAKPAD"},L("report_client_error_with_app_crash_ks")||(a.systemHealth={crashData:{clientError:{logMessage:{message:n.message}}}}),lk("appCrashed",a)),Bn++):"WARNING"===b&&tn.ka("handleWarning",n);if(L("kevlar_gel_error_routing")){a=b;b:{c=q(En);for(d=c.next();!d.done;d=c.next())if(ck(d.value.toLowerCase())){c=!0;break b}c=!1}if(c)c=void 0;else{d={stackTrace:n.stack};n.fileName&&
...
(b["client.version"]=a.version);if(b.postParams){n.stack&&(b.postParams.stack=n.stack);c=q(Object.keys(a));for(d=c.next();!d.done;d=c.next())d=d.value,b.postParams["client."+d]=a[d];if(a=B("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(c=q(Object.keys(a)),d=c.next();!d.done;d=c.next())d=d.value,b.postParams[d]=a[d];a=B("SERVER_NAME",void 0);c=B("SERVER_VERSION",void 0);a&&c&&(b.postParams["server.name"]=a,b.postParams["server.version"]=c)}ti(B("ECATCHER_REPORT_HOST","")+"/error_204",b)}try{zn.add(n.message)}catch(C){}An++}}}
function Hn(a){var b=Ga.apply(1,arguments),c=a;c.args||(c.args=[]);c.args.push.apply(c.args,fa(b))}
;function In(){this.register=new Map}
function Jn(a){a=q(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.yo("ABORTED")}
In.prototype.clear=function(){Jn(this);this.register.clear()};
var Kn=new In;var Ln=Date.now().toString();
function Mn(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=Date.now();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Ln)for(a=1,b=0;b<Ln.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Ln.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Nn,On=x.ytLoggingDocDocumentNonce_;On||(On=Mn(),Wa("ytLoggingDocDocumentNonce_",On));Nn=On;var Pn={ng:0,nd:1,vd:2,Pj:3,pg:4,Ln:5,Fk:6,fm:7,Hl:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function Qn(a){this.h=a}
function Rn(a){return new Qn({trackingParams:a})}
Qn.prototype.getAsJson=function(){var a={};void 0!==this.h.trackingParams?a.trackingParams=this.h.trackingParams:(a.veType=this.h.veType,void 0!==this.h.veCounter&&(a.veCounter=this.h.veCounter),void 0!==this.h.elementIndex&&(a.elementIndex=this.h.elementIndex));void 0!==this.h.dataElement&&(a.dataElement=this.h.dataElement.getAsJson());void 0!==this.h.youtubeData&&(a.youtubeData=this.h.youtubeData);return a};
Qn.prototype.getAsJspb=function(){var a=new vg;void 0!==this.h.trackingParams?G(a,1,this.h.trackingParams):(void 0!==this.h.veType&&G(a,2,this.h.veType),void 0!==this.h.veCounter&&G(a,6,this.h.veCounter),void 0!==this.h.elementIndex&&G(a,3,this.h.elementIndex));if(void 0!==this.h.dataElement){var b=this.h.dataElement.getAsJspb();H(a,7,b)}void 0!==this.h.youtubeData&&H(a,8,this.h.jspbYoutubeData);return a};
Qn.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
Qn.prototype.isClientVe=function(){return!this.h.trackingParams&&!!this.h.veType};function Sn(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Tn(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Un(a){return B(Tn(void 0===a?0:a),void 0)}
y("yt_logging_screen.getRootVeType",Un,void 0);function Vn(a){return(a=Un(void 0===a?0:a))?new Qn({veType:a,youtubeData:void 0,jspbYoutubeData:void 0}):null}
function Wn(){var a=B("csn-to-ctt-auth-info");a||(a={},jh("csn-to-ctt-auth-info",a));return a}
function Xn(a){a=void 0===a?0:a;var b=B(Sn(a));if(!b&&!B("USE_CSN_FALLBACK",!0))return null;b||!L("use_undefined_csn_any_layer")&&0!=a||(b="UNDEFINED_CSN");return b?b:null}
y("yt_logging_screen.getCurrentCsn",Xn,void 0);function Yn(a,b,c){var d=Wn();(c=Xn(c))&&delete d[c];b&&(d[a]=b)}
function Zn(a){return Wn()[a]}
y("yt_logging_screen.getCttAuthInfo",Zn,void 0);function $n(a,b,c,d){c=void 0===c?0:c;if(a!==B(Sn(c))||b!==B(Tn(c)))Yn(a,d,c),jh(Sn(c),a),jh(Tn(c),b),b=function(){setTimeout(function(){if(a){var e={clientDocumentNonce:Nn,clientScreenNonce:a};L("use_default_heartbeat_client")?lk("foregroundHeartbeatScreenAssociated",e):sj("foregroundHeartbeatScreenAssociated",e,mn)}},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
y("yt_logging_screen.setCurrentScreen",$n,void 0);var ao=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",ao,void 0);function bo(a){Zg(ao,arguments)}
;var co={md:3611,Bc:27686,Cc:85013,Dc:23462,Fc:42016,Gc:62407,Hc:26926,Ec:43781,Ic:51236,Jc:79148,Kc:50160,Lc:77504,Xc:87907,Yc:18630,Zc:54445,bd:80935,cd:105675,dd:37521,ed:47786,fd:98349,gd:123695,hd:6827,jd:29434,kd:7282,ld:124448,pd:32276,od:76278,qd:93911,rd:106531,sd:27259,td:27262,ud:27263,wd:21759,xd:27107,yd:62936,zd:49568,Ad:38408,Bd:80637,Cd:68727,Dd:68728,Ed:80353,Fd:80356,Gd:74610,Hd:45707,Id:83962,Jd:83970,Kd:46713,Ld:89711,Md:74612,Nd:93265,Od:74611,Pd:131380,Rd:128979,Sd:139311,Td:128978,
...
Mk:122502,Nk:145268,Ok:138480,Pk:64423,Qk:64424,Rk:33986,Sk:100828,Tk:129089,Uk:21409,Yk:135155,Zk:135156,al:135157,bl:135158,dl:135159,fl:135160,il:135161,jl:135162,kl:135163,ll:135164,ml:135165,nl:135166,Vk:11070,Wk:11074,Xk:17880,ol:14001,ql:30709,rl:30707,sl:30711,ul:30710,vl:30708,pl:26984,wl:63648,xl:63649,yl:51879,zl:111059,Al:5754,Bl:20445,Dl:130975,Cl:130976,El:110386,Fl:113746,Gl:66557,Il:17310,Jl:28631,Kl:21589,Ll:68012,Ml:60480,Nl:138664,Ol:141121,Pl:31571,Ql:141978,Rl:76980,Sl:41577,
Tl:45469,Ul:38669,Vl:13768,Wl:13777,Xl:141842,Yl:62985,Zl:4724,am:59369,bm:43927,cm:43928,dm:12924,em:100355,hm:56219,im:27669,jm:10337,gm:47896,km:122629,mm:139723,lm:139722,nm:121258,om:107598,pm:127991,qm:96639,rm:107536,sm:130169,tm:96661,um:96658,vm:116646,wm:121122,xm:96660,ym:127738,zm:127083,Am:104443,Bm:96659,Cm:106442,Dm:134840,Em:63667,Fm:63668,Gm:63669,Hm:130686,Im:78314,Jm:55761,Km:127098,Lm:134841,Mm:96368,Nm:67374,Om:48992,Pm:49956,Qm:31961,Rm:26388,Sm:23811,Tm:5E4,Um:126250,Vm:96370,
Wm:47355,Xm:47356,Ym:37935,Zm:45521,an:21760,bn:83769,cn:49977,dn:49974,en:93497,fn:93498,gn:34325,hn:140759,jn:115803,kn:123707,ln:100081,mn:35309,nn:68314,pn:25602,qn:100339,rn:143516,sn:59018,tn:18248,un:50625,vn:9729,wn:37168,xn:37169,yn:21667,zn:16749,An:18635,Bn:39305,Cn:18046,Dn:53969,En:8213,Fn:93926,Gn:102852,Hn:110099,In:22678,Jn:69076,Kn:137575,Mn:139224,Nn:100856,On:17736,Pn:3832,Qn:55759,Rn:64031,Xn:93044,Yn:93045,Zn:34388,ao:17657,bo:17655,co:39579,eo:39578,fo:77448,ho:8196,jo:11357,
ko:69877,lo:8197,mo:82039};function eo(){var a=sb(fo),b;return Gf(new zf(function(c,d){a.onSuccess=function(e){ni(e)?c(new go(e)):d(new ho("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new ho("Unknown request error","net.unknown",e))};
a.onTimeout=function(e){d(new ho("Request timed out","net.timeout",e))};
b=ti("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Hf&&b.abort();
return Ef(c)})}
function ho(a,b,c){$a.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
r(ho,$a);function go(a){this.xhr=a}
;function io(){this.i=0;this.h=null}
io.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.h),yf(a)?a:jo(a)):2===this.i&&b?(a=b.call(c,this.h),yf(a)?a:ko(a)):this};
io.prototype.getValue=function(){return this.h};
io.prototype.$goog_Thenable=!0;function ko(a){var b=new io;a=void 0===a?null:a;b.i=2;b.h=void 0===a?null:a;return b}
function jo(a){var b=new io;a=void 0===a?null:a;b.i=1;b.h=void 0===a?null:a;return b}
;function lo(){if(Od())return!0;var a=B("INNERTUBE_CLIENT_NAME");return!a||"WEB"!==a&&"MWEB"!==a||bk&&ck("applewebkit")&&!ck("version")&&(!ck("safari")||ck("gsa/"))||kc&&ck("version/")?!0:(a=yj("CONSENT"))?a.startsWith("YES+"):!0}
;function mo(a){$a.call(this,a.message||a.description||a.name);this.isMissing=a instanceof no;this.isTimeout=a instanceof ho&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Hf}
r(mo,$a);mo.prototype.name="BiscottiError";function no(){$a.call(this,"Biscotti ID is missing from server")}
r(no,$a);no.prototype.name="BiscottiMissingError";var fo={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},oo=null;function Yh(){if(L("disable_biscotti_fetch_entirely_for_all_web_clients"))return Ef(Error("Biscotti id fetching has been disabled entirely."));if(!lo())return Ef(Error("User has not consented - not fetching biscotti id."));if("1"==qb())return Ef(Error("Biscotti ID is not available in private embed mode"));oo||(oo=Gf(eo().then(po),function(a){return qo(2,a)}));
return oo}
function po(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new no;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new no;a=a.id;Zh(a);oo=jo(a);ro(18E5,2);return a}
function qo(a,b){b=new mo(b);Zh("");oo=ko(b);0<a&&ro(12E4,a-1);throw b;}
function ro(a,b){Hh(function(){Gf(eo().then(po,function(c){return qo(b,c)}),Ja)},a)}
function so(){try{var a=A("yt.ads.biscotti.getId_");return a?a():Yh()}catch(b){return Ef(b)}}
;function to(a){if("1"!=qb()){a&&Xh();try{so().then(function(){},function(){}),Hh(to,18E5)}catch(b){wh(b)}}}
;function uo(){this.yc=!0}
function vo(a){var b={},c=Qd([]);c&&(b.Authorization=c,c=a=null==a?void 0:a.sessionIndex,void 0===c&&(c=Number(B("SESSION_INDEX",0)),c=isNaN(c)?0:c),b["X-Goog-AuthUser"]=c,"INNERTUBE_HOST_OVERRIDE"in ch||(b["X-Origin"]=window.location.origin),void 0===a&&"DELEGATED_SESSION_ID"in ch&&(b["X-Goog-PageId"]=B("DELEGATED_SESSION_ID")));return b}
;var wo={identityType:"UNAUTHENTICATED_IDENTITY_TYPE_UNKNOWN"};var xo=new Map([["dark","USER_INTERFACE_THEME_DARK"],["light","USER_INTERFACE_THEME_LIGHT"]]),yo=["/fashion","/feed/fashion_destination","/channel/UCrpQ4p1Ql_hG8rKXIKM1MOQ"];function zo(){var a=void 0===a?window.location.href:a;if(L("kevlar_disable_theme_param"))return null;var b=Xb(a.match(Wb)[5]||null);if(Ao(b))return"USER_INTERFACE_THEME_DARK";try{var c=gi(a).theme;return xo.get(c)||null}catch(d){}return null}
function Ao(a){var b=yo.map(function(c){return c.toLowerCase()});
return!L("disable_dark_fashion_destination_launch")&&b.some(function(c){return a.toLowerCase().startsWith(c)})?!0:!1}
;function Bo(){this.h={};if(this.i=zj()){var a=yj("CONSISTENCY");a&&Co(this,{encryptedTokenJarContents:a})}}
Bo.prototype.handleResponse=function(a,b){var c,d;b=(null==(c=b.ba.context)?void 0:null==(d=c.request)?void 0:d.consistencyTokenJars)||[];var e;(a=null==(e=a.responseContext)?void 0:e.consistencyTokenJar)&&this.replace(b,a)};
Bo.prototype.replace=function(a,b){a=q(a);for(var c=a.next();!c.done;c=a.next())delete this.h[c.value.encryptedTokenJarContents];Co(this,b)};
function Co(a,b){if(b.encryptedTokenJarContents&&(a.h[b.encryptedTokenJarContents]=b,"string"===typeof b.expirationSeconds)){var c=Number(b.expirationSeconds);setTimeout(function(){delete a.h[b.encryptedTokenJarContents]},1E3*c);
a.i&&xj("CONSISTENCY",b.encryptedTokenJarContents,c,void 0,!0)}}
;var Do=window.location.hostname.split(".").slice(-2).join(".");function Eo(){var a=B("LOCATION_PLAYABILITY_TOKEN");"TVHTML5"===B("INNERTUBE_CLIENT_NAME")&&(this.h=Fo(this))&&(a=this.h.get("yt-location-playability-token"));a&&(this.locationPlayabilityToken=a,this.i=void 0)}
var Go;Eo.getInstance=function(){Go=A("yt.clientLocationService.instance");Go||(Go=new Eo,y("yt.clientLocationService.instance",Go,void 0));return Go};
Eo.prototype.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.i?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=1E7*this.i.coords.latitude,a.client.locationInfo.longitudeE7=1E7*this.i.coords.longitude,a.client.locationInfo.horizontalAccuracyMeters=this.i.coords.accuracy,a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
Eo.prototype.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.i=void 0,"TVHTML5"===B("INNERTUBE_CLIENT_NAME")?(this.h=Fo(this))&&this.h.set("yt-location-playability-token",a,15552E3):xj("YT_CL",JSON.stringify({loctok:a}),15552E3,Do,!0))};
function Fo(a){return void 0===a.h?new Vj("yt-client-location"):a.h}
Eo.prototype.getCurrentPositionFromGeolocation=function(){var a=this;if(!(navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition)||!L("web_enable_browser_geolocation_api")&&!L("enable_handoff_location_2fa_on_mweb"))return Promise.reject(Error("Geolocation unsupported"));var b=!1,c=1E4;L("enable_handoff_location_2fa_on_mweb")&&(b=!0,c=15E3);return new Promise(function(d,e){navigator.geolocation.getCurrentPosition(function(f){a.i=f;d(f)},function(f){e(f)},{enableHighAccuracy:b,
maximumAge:0,timeout:c})})};
Eo.prototype.createUnpluggedLocationInfo=function(a){var b={};a=a.coords;if(null==a?0:a.latitude)b.latitudeE7=Math.floor(1E7*a.latitude);if(null==a?0:a.longitude)b.longitudeE7=Math.floor(1E7*a.longitude);if(null==a?0:a.accuracy)b.locationRadiusMeters=Math.round(a.accuracy);return b};function Ho(a,b){var c;if((null==(c=a.signalServiceEndpoint)?0:c.signal)&&b.Ba&&(c=b.Ba[a.signalServiceEndpoint.signal]))return c();var d;if((null==(d=a.continuationCommand)?0:d.request)&&b.Rb&&(d=b.Rb[a.continuationCommand.request]))return d();for(var e in a)if(b.pb[e]&&(a=b.pb[e]))return a()}
;function Io(a){return function(){return new a}}
;var Jo={},Ko=(Jo.WEB_UNPLUGGED="^unplugged/",Jo.WEB_UNPLUGGED_ONBOARDING="^unplugged/",Jo.WEB_UNPLUGGED_OPS="^unplugged/",Jo.WEB_UNPLUGGED_PUBLIC="^unplugged/",Jo.WEB_CREATOR="^creator/",Jo.WEB_KIDS="^kids/",Jo.WEB_EXPERIMENTS="^experiments/",Jo.WEB_MUSIC="^music/",Jo.WEB_REMIX="^music/",Jo.WEB_MUSIC_EMBEDDED_PLAYER="^music/",Jo.WEB_MUSIC_EMBEDDED_PLAYER="^main_app/|^sfv/",Jo);
function Lo(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=Ko[b];if(c){var d=new RegExp(c),e=q(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(Ko).forEach(function(g){var h=q(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
d=new RegExp(f.join("|"));a.sort(function(g,h){return g.length-h.length});
e=q(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,!d.exec(c))return c;return a[0]}
;function Mo(a,b){return{method:void 0===b?"POST":b,mode:ii(a)?"same-origin":"cors",credentials:ii(a)?"same-origin":"include"}}
;function No(){}
No.prototype.o=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?wo:c;var d=a.clickTrackingParams,e=this.l,f=!1;f=void 0===f?!1:f;e=void 0===e?!1:e;var g=B("INNERTUBE_CONTEXT");if(g){g=tb(g);L("web_no_tracking_params_in_shell_killswitch")||delete g.clickTracking;g.client||(g.client={});var h=g.client;"MWEB"===h.clientName&&(h.clientFormFactor=B("IS_TABLET")?"LARGE_FORM_FACTOR":"SMALL_FORM_FACTOR");h.screenWidthPoints=window.innerWidth;h.screenHeightPoints=window.innerHeight;h.screenPixelDensity=Math.round(window.devicePixelRatio||
1);h.screenDensityFloat=window.devicePixelRatio||1;h.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var k=void 0===k?!1:k;Bj.getInstance();var m="USER_INTERFACE_THEME_LIGHT";Ej(165)?m="USER_INTERFACE_THEME_DARK":Ej(174)?m="USER_INTERFACE_THEME_LIGHT":!L("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(m="USER_INTERFACE_THEME_DARK");k=k?m:zo()||m;h.userInterfaceTheme=k;if(!f){if(k=
...
if(!L("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var z=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(Q){}z=void 0}z&&(h.timeZone=z)}(z=nh())?h.experimentsToken=z:delete h.experimentsToken;z=oh();Bo.h||(Bo.h=new Bo);h=Bo.h.h;t=[];n=0;for(var v in h)t[n++]=h[v];g.request=Object.assign({},g.request,{internalExperimentFlags:z,consistencyTokenJars:t});!L("web_prequest_context_killswitch")&&(v=B("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&(g.request.externalPrequestContext=
v);z=Bj.getInstance();v=Ej(58);z=z.get("gsml","");g.user=Object.assign({},g.user);v&&(g.user.enableSafetyMode=v);z&&(g.user.lockedSafetyMode=!0);L("warm_op_csn_cleanup")?e&&(f=Xn())&&(g.clientScreenNonce=f):!f&&(f=Xn())&&(g.clientScreenNonce=f);d&&(g.clickTracking={clickTrackingParams:d});if(d=A("yt.mdx.remote.remoteClient_"))g.remoteClient=d;L("web_enable_client_location_service")&&Eo.getInstance().setLocationOnInnerTubeContext(g);try{var C=ji(void 0),D=C.bid;delete C.bid;g.adSignalsInfo={params:[],
bid:D};var F=q(Object.entries(C));for(var P=F.next();!P.done;P=F.next()){var U=q(P.value),W=U.next().value,Ra=U.next().value;C=W;D=Ra;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:C,value:""+D})}}catch(Q){Fn(Q)}F=g}else Fn(Error("Error: No InnerTubeContext shell provided in ytconfig.")),F={};F={context:F};if(P=this.h(a)){this.i(F,P,b);var Y;b="/youtubei/v1/"+Lo(this.j());var wa;(a=null==(Y=a.commandMetadata)?void 0:null==(wa=Y.webCommandMetadata)?void 0:wa.apiUrl)&&(b=a);Y=b;(wa=B("INNERTUBE_HOST_OVERRIDE"))&&
(Y=String(wa)+String(Zb(Y)));wa={};wa.key=B("INNERTUBE_API_KEY");L("json_condensed_response")&&(wa.prettyPrint="false");Y=hi(Y,wa||{},!1);Y={input:Y,ta:Mo(Y),ba:F,config:Object.assign({},void 0)};Y.config.Ia?Y.config.Ia.identity=c:Y.config.Ia={identity:c};return Y}Fn(new ok("Error: Failed to create Request from Command.",a))};
da.Object.defineProperties(No.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!1}}});function Oo(){}
r(Oo,No);Oo.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",ta:Mo("/getDatasyncIdsEndpoint","GET"),ba:{}}};
Oo.prototype.j=function(){return[]};
Oo.prototype.h=function(){};
Oo.prototype.i=function(){};var Po={},Qo=(Po.GET_DATASYNC_IDS=Io(Oo),Po);function Ro(a){var b=Ga.apply(1,arguments);if(!So(a)||b.some(function(e){return!So(e)}))throw Error("Only objects may be merged.");
var c=a;b=q(b);for(var d=b.next();!d.done;d=b.next())To(c,d.value);return c}
...
function Vo(a,b){b=q(b);for(var c=b.next();!c.done;c=b.next())c=c.value,So(c)?a.push(To({},c)):Uo(c)?a.push(Vo([],c)):a.push(c);return a}
function So(a){return"object"===typeof a&&!Array.isArray(a)}
function Uo(a){return"object"===typeof a&&Array.isArray(a)}
;function Wo(a,b){Ql.call(this,1,arguments);this.timer=b}
r(Wo,Ql);var Xo=new Rl("aft-recorded",Wo);var Yo=window;function Zo(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var O=Yo.performance||Yo.mozPerformance||Yo.msPerformance||Yo.webkitPerformance||new Zo;var $o=!1,ap={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"},
bp=Ua(O.clearResourceTimings||O.webkitClearResourceTimings||O.mozClearResourceTimings||O.msClearResourceTimings||O.oClearResourceTimings||Ja,O);function cp(a){var b=dp(a);if(b.aft)return b.aft;a=B((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function ep(){var a;if(L("csi_use_performance_navigation_timing")){var b,c,d,e=null==O?void 0:null==(a=O.getEntriesByType)?void 0:null==(b=a.call(O,"navigation"))?void 0:null==(c=b[0])?void 0:null==(d=c.toJSON)?void 0:d.call(c);e?(e.requestStart=fp(e.requestStart),e.responseEnd=fp(e.responseEnd),e.redirectStart=fp(e.redirectStart),e.redirectEnd=fp(e.redirectEnd),e.domainLookupEnd=fp(e.domainLookupEnd),e.connectStart=fp(e.connectStart),e.connectEnd=fp(e.connectEnd),e.responseStart=fp(e.responseStart),
e.secureConnectionStart=fp(e.secureConnectionStart),e.domainLookupStart=fp(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=O.timing}else a=O.timing;return a}
function gp(){return L("csi_use_time_origin")&&O.timeOrigin?Math.floor(O.timeOrigin):O.timing.navigationStart}
function fp(a){return Math.round(gp()+a)}
function hp(a){y("ytglobal.timing"+(a||"")+"ready_",!0,void 0)}
function ip(a){return A("ytcsi."+(a||"")+"data_")||jp(a)}
function kp(a){a=ip(a);a.info||(a.info={});return a.info}
function dp(a){a=ip(a);a.tick||(a.tick={});return a.tick}
function lp(a){a=ip(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
function mp(a){a=lp(a);a.gelInfos||(a.gelInfos={});return a.gelInfos}
function np(a){var b=ip(a).nonce;b||(b=Mn(),ip(a).nonce=b);return b}
function jp(a){var b={tick:{},info:{}};y("ytcsi."+(a||"")+"data_",b,void 0);return b}
function op(a){var b=dp(a||""),c=cp(a);c&&!$o&&(Wl(Xo,new Wo(Math.round(c-b._start),a)),$o=!0)}
function pp(a,b){for(var c=q(Object.keys(b)),d=c.next();!d.done;d=c.next())if(d=d.value,!Object.keys(a).includes(d)||"object"===typeof b[d]&&!pp(a[d],b[d]))return!1;return!0}
;function qp(){if(O.getEntriesByType){var a=O.getEntriesByType("paint");if(a=ib(a,function(b){return"first-paint"===b.name}))return fp(a.startTime)}a=O.timing;
return a.dc?Math.max(0,a.dc):0}
;function rp(){var a=A("ytcsi.debug");a||(a=[],y("ytcsi.debug",a,void 0),y("ytcsi.reference",{},void 0));return a}
function sp(a){a=a||"";var b=tp();if(b[a])return b[a];var c=rp(),d={timerName:a,info:{},tick:{},span:{},jspbInfo:[]};c.push(d);return b[a]=d}
function tp(){var a=A("ytcsi.reference");if(a)return a;rp();return A("ytcsi.reference")}
;var R={},up=(R.auto_search="LATENCY_ACTION_AUTO_SEARCH",R.ad_to_ad="LATENCY_ACTION_AD_TO_AD",R.ad_to_video="LATENCY_ACTION_AD_TO_VIDEO",R["analytics.explore"]="LATENCY_ACTION_CREATOR_ANALYTICS_EXPLORE",R.app_startup="LATENCY_ACTION_APP_STARTUP",R["artist.analytics"]="LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS",R["artist.events"]="LATENCY_ACTION_CREATOR_ARTIST_CONCERTS",R["artist.presskit"]="LATENCY_ACTION_CREATOR_ARTIST_PROFILE",R.browse="LATENCY_ACTION_BROWSE",R.cast_splash="LATENCY_ACTION_CAST_SPLASH",
...
S.yt_vis="isVisible",S.rcl="mwebInfo.responseContentLength",S.GetSettings_rid="requestIds",S.GetTrending_rid="requestIds",S.GetMusicSearchSuggestions_rid="requestIds",S.REQUEST_ID="requestIds",S),wp="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
xp={},yp=(xp.ccs="CANARY_STATE_",xp.mver="MEASUREMENT_VERSION_",xp.pis="PLAYER_INITIALIZED_STATE_",xp.yt_pt="LATENCY_PLAYER_",xp.pa="LATENCY_ACTION_",xp.ctop="TOP_ENTITY_TYPE_",xp.yt_vst="VIDEO_STREAM_TYPE_",xp),zp="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function Ap(a){return up[a]||"LATENCY_ACTION_UNKNOWN"}
function Bp(a,b,c){c=lp(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in vp){c=vp[a];0<=cb(wp,c)&&(b=!!b);a in yp&&"string"===typeof b&&(b=yp[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return Ro({},d)}0<=cb(zp,a)||Gn(new ok("Unknown label logged with GEL CSI",a))}
...
T[T.LATENCY_ACTION_STARTUP]="LATENCY_ACTION_STARTUP";T[T.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var Cp={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};Cp[Cp.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";Cp[Cp.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";Cp[Cp.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
X[X.DETAILED_NETWORK_TYPE_1_X_RTT]="DETAILED_NETWORK_TYPE_1_X_RTT";X[X.DETAILED_NETWORK_TYPE_GPRS]="DETAILED_NETWORK_TYPE_GPRS";X[X.DETAILED_NETWORK_TYPE_EDGE]="DETAILED_NETWORK_TYPE_EDGE";X[X.DETAILED_NETWORK_TYPE_UNKNOWN]="DETAILED_NETWORK_TYPE_UNKNOWN";var Dp={LATENCY_PLAYER_RTSP:7,LATENCY_PLAYER_HTML5_INLINE:6,LATENCY_PLAYER_HTML5_FULLSCREEN:5,LATENCY_PLAYER_HTML5:4,LATENCY_PLAYER_FRAMEWORK:3,LATENCY_PLAYER_FLASH:2,LATENCY_PLAYER_EXO:1,LATENCY_PLAYER_UNKNOWN:0};Dp[Dp.LATENCY_PLAYER_RTSP]="LATENCY_PLAYER_RTSP";
Dp[Dp.LATENCY_PLAYER_HTML5_INLINE]="LATENCY_PLAYER_HTML5_INLINE";Dp[Dp.LATENCY_PLAYER_HTML5_FULLSCREEN]="LATENCY_PLAYER_HTML5_FULLSCREEN";Dp[Dp.LATENCY_PLAYER_HTML5]="LATENCY_PLAYER_HTML5";Dp[Dp.LATENCY_PLAYER_FRAMEWORK]="LATENCY_PLAYER_FRAMEWORK";Dp[Dp.LATENCY_PLAYER_FLASH]="LATENCY_PLAYER_FLASH";Dp[Dp.LATENCY_PLAYER_EXO]="LATENCY_PLAYER_EXO";Dp[Dp.LATENCY_PLAYER_UNKNOWN]="LATENCY_PLAYER_UNKNOWN";
var Ep={LATENCY_AD_BREAK_TYPE_POSTROLL:3,LATENCY_AD_BREAK_TYPE_MIDROLL:2,LATENCY_AD_BREAK_TYPE_PREROLL:1,LATENCY_AD_BREAK_TYPE_UNKNOWN:0};Ep[Ep.LATENCY_AD_BREAK_TYPE_POSTROLL]="LATENCY_AD_BREAK_TYPE_POSTROLL";Ep[Ep.LATENCY_AD_BREAK_TYPE_MIDROLL]="LATENCY_AD_BREAK_TYPE_MIDROLL";Ep[Ep.LATENCY_AD_BREAK_TYPE_PREROLL]="LATENCY_AD_BREAK_TYPE_PREROLL";Ep[Ep.LATENCY_AD_BREAK_TYPE_UNKNOWN]="LATENCY_AD_BREAK_TYPE_UNKNOWN";var Fp={LATENCY_ACTION_ERROR_STARTUP_TIMEOUT:1,LATENCY_ACTION_ERROR_UNSPECIFIED:0};
Fp[Fp.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT]="LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";Fp[Fp.LATENCY_ACTION_ERROR_UNSPECIFIED]="LATENCY_ACTION_ERROR_UNSPECIFIED";var Gp={LIVE_STREAM_MODE_WINDOW:5,LIVE_STREAM_MODE_POST:4,LIVE_STREAM_MODE_LP:3,LIVE_STREAM_MODE_LIVE:2,LIVE_STREAM_MODE_DVR:1,LIVE_STREAM_MODE_UNKNOWN:0};Gp[Gp.LIVE_STREAM_MODE_WINDOW]="LIVE_STREAM_MODE_WINDOW";Gp[Gp.LIVE_STREAM_MODE_POST]="LIVE_STREAM_MODE_POST";Gp[Gp.LIVE_STREAM_MODE_LP]="LIVE_STREAM_MODE_LP";
Gp[Gp.LIVE_STREAM_MODE_LIVE]="LIVE_STREAM_MODE_LIVE";Gp[Gp.LIVE_STREAM_MODE_DVR]="LIVE_STREAM_MODE_DVR";Gp[Gp.LIVE_STREAM_MODE_UNKNOWN]="LIVE_STREAM_MODE_UNKNOWN";var Hp={VIDEO_STREAM_TYPE_VOD:3,VIDEO_STREAM_TYPE_DVR:2,VIDEO_STREAM_TYPE_LIVE:1,VIDEO_STREAM_TYPE_UNSPECIFIED:0};Hp[Hp.VIDEO_STREAM_TYPE_VOD]="VIDEO_STREAM_TYPE_VOD";Hp[Hp.VIDEO_STREAM_TYPE_DVR]="VIDEO_STREAM_TYPE_DVR";Hp[Hp.VIDEO_STREAM_TYPE_LIVE]="VIDEO_STREAM_TYPE_LIVE";Hp[Hp.VIDEO_STREAM_TYPE_UNSPECIFIED]="VIDEO_STREAM_TYPE_UNSPECIFIED";
var Ip={YT_IDB_TRANSACTION_TYPE_READ:2,YT_IDB_TRANSACTION_TYPE_WRITE:1,YT_IDB_TRANSACTION_TYPE_UNKNOWN:0};Ip[Ip.YT_IDB_TRANSACTION_TYPE_READ]="YT_IDB_TRANSACTION_TYPE_READ";Ip[Ip.YT_IDB_TRANSACTION_TYPE_WRITE]="YT_IDB_TRANSACTION_TYPE_WRITE";Ip[Ip.YT_IDB_TRANSACTION_TYPE_UNKNOWN]="YT_IDB_TRANSACTION_TYPE_UNKNOWN";var Jp={PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN:2,PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT:1,PLAYER_ROTATION_TYPE_UNKNOWN:0};Jp[Jp.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN]="PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
Jp[Jp.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";Jp[Jp.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var Kp=x.ytLoggingGelSequenceIdObj_||{};y("ytLoggingGelSequenceIdObj_",Kp,void 0);function Lp(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||M());G(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Wh();d=new Og;G(d,1,c.timestamp||!isFinite(e)?-1:e);if(L("log_sequence_info_on_gel_web")&&c.X){e=c.X;var f=tj(e),g=new Ng;G(g,2,f);G(g,1,e);H(d,3,g);c.ub&&delete Kp[c.X]}H(a,33,d);(c.nc?ej:$i)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,xa:c.xa},b)}
;function Mp(a,b){b=void 0===b?{}:b;var c=!1;B("ytLoggingEventsDefaultDisabled",!1)&&mn===mn&&(c=!0);Lp(a,c?null:mn,b)}
;function Np(a,b,c){var d=new Pg;Nc(d,72,a);c?Lp(d,c,b):Mp(d,b)}
function Op(a,b,c){var d=new Pg;Nc(d,73,a);c?Lp(d,c,b):Mp(d,b)}
function Pp(a,b,c){var d=new Pg;Nc(d,78,a);c?Lp(d,c,b):Mp(d,b)}
function Qp(a,b,c){var d=new Pg;Nc(d,208,a);c?Lp(d,c,b):Mp(d,b)}
function Rp(a,b,c){var d=new Pg;Nc(d,156,a);c?Lp(d,c,b):Mp(d,b)}
function Sp(a,b,c){var d=new Pg;Nc(d,215,a);c?Lp(d,c,b):Mp(d,b)}
;var Tp=x.ytLoggingLatencyUsageStats_||{};y("ytLoggingLatencyUsageStats_",Tp,void 0);function Up(){this.h=0}
function Vp(){Up.h||(Up.h=new Up);return Up.h}
Up.prototype.tick=function(a,b,c,d){Wp(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},L("web_csi_via_jspb")?(d=new Mg,G(d,1,a),G(d,2,b),a=new Pg,Nc(a,5,d),Mp(a,c)):lk("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
Up.prototype.info=function(a,b,c){var d=Object.keys(a).join("");Wp(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,lk("latencyActionInfo",a,{cttAuthInfo:c}))};
Up.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Wp(this,"info_"+d+"_"+b)||(G(a,2,b),b={cttAuthInfo:c},c=new Pg,Nc(c,7,a),Mp(c,b))};
Up.prototype.span=function(a,b,c){var d=Object.keys(a).join("");Wp(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,lk("latencyActionSpan",a,{cttAuthInfo:c}))};
function Wp(a,b){Tp[b]=Tp[b]||{count:0};var c=Tp[b];c.count++;c.time=M();a.h||(a.h=Lh(function(){var d=M(),e;for(e in Tp)Tp[e]&&6E4<d-Tp[e].time&&delete Tp[e];a&&(a.h=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new ok("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Gn(c)),!0):!1}
;function Xp(){var a=["ol"];sp("").info.actionType="embed";a&&jh("TIMING_AFT_KEYS",a);jh("TIMING_ACTION","embed");a=B("TIMING_INFO",{});for(var b in a)a.hasOwnProperty(b)&&Yp(b,a[b]);b={isNavigation:!0,actionType:Ap(kh("TIMING_ACTION"))};if(a=kh("PREVIOUS_ACTION"))b.previousAction=Ap(a);if(a=B("CLIENT_PROTOCOL"))b.httpProtocol=a;if(a=B("CLIENT_TRANSPORT"))b.transportProtocol=a;(a=Xn())&&"UNDEFINED_CSN"!==a&&(b.clientScreenNonce=a);a=Zp();if(1===a||-1===a)b.isVisible=!0;a=kp();b.loadType="cold";var c=
ep(),d=gp();d&&(Z("srt",c.responseStart),1!==a.prerender&&Z("_start",d,void 0));a=qp();0<a&&Z("fpt",a);a=ep();a.isPerformanceNavigationTiming&&$p({performanceNavigationTiming:!0},void 0);Z("nreqs",a.requestStart,void 0);Z("nress",a.responseStart,void 0);Z("nrese",a.responseEnd,void 0);0<a.redirectEnd-a.redirectStart&&(Z("nrs",a.redirectStart,void 0),Z("nre",a.redirectEnd,void 0));0<a.domainLookupEnd-a.domainLookupStart&&(Z("ndnss",a.domainLookupStart,void 0),Z("ndnse",a.domainLookupEnd,void 0));0<
a.connectEnd-a.connectStart&&(Z("ntcps",a.connectStart,void 0),Z("ntcpe",a.connectEnd,void 0));a.secureConnectionStart>=gp()&&0<a.connectEnd-a.secureConnectionStart&&(Z("nstcps",a.secureConnectionStart,void 0),Z("ntcpe",a.connectEnd,void 0));O&&"getEntriesByType"in O&&aq();a=[];if(document.querySelector&&O&&O.getEntriesByName)for(var e in ap)ap.hasOwnProperty(e)&&(c=ap[e],bq(e,c)&&a.push(c));if(0<a.length)for(b.resourceInfo=[],e=q(a),a=e.next();!a.done;a=e.next())b.resourceInfo.push({resourceCache:a.value});
$p(b);e=kp();b=mp();if("cold"===e.yt_lt||"cold"===b.loadType){a=dp();c=lp();c=c.gelTicks?c.gelTicks:c.gelTicks={};for(var f in a)f in c||Z(f,a[f]);f={};a=!1;c=q(Object.keys(e));for(d=c.next();!d.done;d=c.next())d=d.value,(d=Bp(d,e[d]))&&!pp(mp(void 0),d)&&(Ro(b,d),Ro(f,d),a=!0);a&&$p(f)}hp();f=kh("TIMING_ACTION");A("ytglobal.timingready_")&&f&&"_start"in dp(void 0)&&cp()&&op()}
function Yp(a,b,c){null!==b&&(kp(c)[a]=b,(a=Bp(a,b,c))&&$p(a,c))}
function $p(a,b){if(L("web_csi_via_jspb")){var c=new Jg,d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++)switch(d[e]){case "actionType":G(c,1,T[a[e]]);break;case "clientActionNonce":G(c,2,a[e]);break;case "clientScreenNonce":G(c,4,a[e]);break;case "actionVisualElement":H(c,88,a[e]);break;case "loadType":G(c,3,a[e]);break;case "isFirstInstall":G(c,55,a[e]);break;case "networkType":G(c,5,Cp[a[e]]);break;case "connectionType":G(c,26,V[a[e]]);break;case "detailedConnectionType":G(c,27,X[a[e]]);
break;case "isVisible":G(c,6,a[e]);break;case "playerType":G(c,7,Dp[a[e]]);break;case "clientPlaybackNonce":G(c,8,a[e]);break;case "adClientPlaybackNonce":G(c,28,a[e]);break;case "previousCpn":G(c,77,a[e]);break;case "targetCpn":G(c,76,a[e]);break;case "isMonetized":G(c,9,a[e]);break;case "isPrerollAllowed":G(c,16,a[e]);break;case "isPrerollShown":G(c,17,a[e]);break;case "adType":G(c,12,a[e]);break;case "adTypesAllowed":G(c,36,a[e]);break;case "adNetworks":G(c,37,a[e]);break;case "previousAction":G(c,
13,T[a[e]]);break;case "isRedSubscriber":G(c,14,a[e]);break;case "serverTimeMs":G(c,15,a[e]);break;case "spinnerInfo":H(c,18,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":G(c,20,a[e]);break;case "targetVideoId":G(c,78,a[e]);break;case "adBreakType":G(c,21,Ep[a[e]]);break;case "isNavigation":G(c,25,a[e]);break;case "viewportHeight":G(c,29,a[e]);break;case "viewportWidth":G(c,30,a[e]);break;case "screenHeight":G(c,84,a[e]);break;case "screenWidth":G(c,85,a[e]);break;case "browseId":G(c,
...
71,Fp[a[e]]);break;case "actionStep":G(c,79,a[e]);break;case "jsHeapSizeLimit":G(c,80,a[e]);break;case "totalJsHeapSize":G(c,81,a[e]);break;case "usedJsHeapSize":G(c,82,a[e]);break;case "resourceInfo":Pc(c,83,Ig,a[e]);break;case "sourceVideoDurationMs":G(c,90,a[e]);break;case "playerInfo":H(c,22,a[e]);break;case "commentInfo":H(c,23,a[e]);break;case "mdxInfo":H(c,24,a[e]);break;case "watchInfo":H(c,35,a[e]);break;case "adPrebufferedTimeSecs":G(c,39,a[e]);break;case "thumbnailLoadInfo":H(c,40,a[e]);
break;case "creatorInfo":H(c,46,a[e]);break;case "unpluggedInfo":H(c,50,a[e]);break;case "isLivestream":G(c,47,a[e]);break;case "liveStreamMode":G(c,91,Gp[a[e]]);break;case "adCpn2":G(c,48,a[e]);break;case "adDaiDriftMillis":G(c,49,a[e]);break;case "videoStreamType":G(c,53,Hp[a[e]]);break;case "reelInfo":H(c,54,a[e]);break;case "subscriptionsFeedInfo":H(c,72,a[e]);break;case "playbackRequiresTap":G(c,56,a[e]);break;case "requestIds":Pc(c,68,Lg,a[e]);break;case "mediaBrowserActionInfo":H(c,58,a[e]);
break;case "performanceNavigationTiming":G(c,67,a[e]);break;case "musicLoadActionInfo":H(c,69,a[e]);break;case "transactionType":G(c,74,Ip[a[e]]);break;case "shoppingInfo":H(c,75,a[e]);break;case "prefetchInfo":H(c,86,a[e]);break;case "accelerationSession":H(c,87,a[e]);break;case "playerRotationType":G(c,101,Jp[a[e]]);break;case "webInfo":H(c,38,a[e]);break;case "tvInfo":H(c,51,a[e]);break;case "kabukiInfo":H(c,52,a[e]);break;case "mwebInfo":H(c,59,a[e]);break;case "musicInfo":H(c,65,a[e]);break;
case "allowedPreroll":G(c,10,a[e]);break;case "shownPreroll":G(c,11,a[e]);break;case "getHomeRequestId":G(c,57,a[e]);break;case "getSearchRequestId":G(c,60,a[e]);break;case "getPlayerRequestId":G(c,61,a[e]);break;case "getWatchNextRequestId":G(c,62,a[e]);break;case "getBrowseRequestId":G(c,63,a[e]);break;case "getLibraryRequestId":G(c,66,a[e])}a=lp(b);a.jspbInfos||(a.jspbInfos=[]);a.jspbInfos.push(c);sp(b||"").jspbInfo.push(c);a=np(b);b=ip(b).cttAuthInfo;Vp().jspbInfo(c,a,b)}else c=sp(b||""),Ro(c.info,
a),Ro(mp(b),a),c=np(b),b=ip(b).cttAuthInfo,Vp().info(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;O.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),O.mark(d))}sp(c||"").tick[a]=b||M();d=lp(c);d.gelTicks&&(d.gelTicks[a]=!0);d=dp(c);var e=b||M();d[a]=e;e=np(c);var f=ip(c).cttAuthInfo;if("_start"===a){var g=Vp();Wp(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},L("web_csi_via_jspb")?(f=new Hg,G(f,1,e),e=new Pg,Nc(e,6,f),Mp(e,b)):lk("latencyActionBaselined",{clientActionNonce:e},b))}else Vp().tick(a,e,b,f);op(c);return d[a]}
function cq(){var a=np(void 0);requestAnimationFrame(function(){setTimeout(function(){a===np(void 0)&&Z("ol",void 0,void 0)},0)})}
function Zp(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=sh+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function bq(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);Tb()&&a.setAttribute("nonce",Tb());return c?(a=O.getEntriesByName(c))&&a[0]&&(a=a[0],c=gp(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function aq(){var a=window.location.protocol,b=O.getEntriesByType("resource");b=eb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=gb(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Z("wffs",fp(b.startTime)),Z("wffe",fp(b.responseEnd)))}
var dq=window;dq.ytcsi&&(dq.ytcsi.info=Yp,dq.ytcsi.tick=Z);var eq=["consistency","mss","client_location","entities","store"];function fq(a,b,c,d,e){this.o=a;this.I=b;this.l=c;this.m=d;this.j=e;this.i=void 0;this.h=new Map;a.Ba||(a.Ba={});a.Ba=Object.assign({},Qo,a.Ba)}
function gq(a,b,c,d,e){if(void 0!==fq.h){if(d=fq.h,a=[a!==d.o,b!==d.I,c!==d.l,!1,!1,void 0!==d.i],a.some(function(f){return f}))throw new ok("InnerTubeTransportService is already initialized",a);
}else fq.h=new fq(a,b,c,d,e)}
function hq(){var a=fq.h,b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?wo:c;var d=Ho(b,a.o);if(!d)return Ef(new ok("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new zf(function(f){var g,h,k;return w(function(m){if(1==m.h)return h="cors"===(null==(g=e.ta)?void 0:g.mode)?"cors":void 0,u(m,iq(a,e.config,h),2);k=m.i;f(jq(a,e,k));m.h=0})}):Ef(new ok("Error: Failed to build request for command.",b))}
function jq(a,b,c){var d,e,f,g,h,k,m,n,t,z,v,C,D,F,P,U,W,Ra,Y,wa;return w(function(Q){switch(Q.h){case 1:Q.s(2);break;case 3:if((d=Q.i)&&!d.isExpired())return Q.return(Promise.resolve(d.h()));case 2:if((f=null==(e=b.config)?void 0:e.zo)&&a.h.has(f)&&L("web_memoize_inflight_requests"))return Q.return(a.h.get(f));if(null==(g=b)?0:null==(h=g.ba)?0:h.context)for(k=q([]),m=k.next();!m.done;m=k.next())n=m.value,n.xo(b.ba.context);if(null==(t=a.i)?0:t.l(b.input,b.ba))return Q.return(a.i.j(b.input,b.ba));
z=JSON.stringify(b.ba);b.ta=Object.assign({},b.ta,{headers:c});v=Object.assign({},b.ta);"POST"===b.ta.method&&(v=Object.assign({},v,{body:z}));(null==(C=b.config)?0:C.jc)&&Z(b.config.jc);D=a.I.fetch(b.input,v,b.config);f&&a.h.set(f,D);return u(Q,D,4);case 4:F=Q.i;f&&a.h.has(f)&&a.h.delete(f);(null==(P=b.config)?0:P.kc)&&Z(b.config.kc);if(F||null==(U=a.i)||!U.h(b.input,b.ba)){Q.s(5);break}return u(Q,a.i.i(b.input,b.ba),6);case 6:F=Q.i;case 5:if(L("web_ordered_response_processors")&&F&&a.j)for(W=q(eq),
...
function iq(a,b,c){return w(function(d){if(a.l.yc){var e=d.return,f,g=null==b?void 0:null==(f=b.Ia)?void 0:f.sessionIndex;f=vo({sessionIndex:g});f=Object.assign({},kq(c),f);d=e.call(d,f)}else d=d.return(lq(b,c));return d})}
function lq(a,b){var c,d,e,f;return w(function(g){if(1==g.h){e=null==(c=a)?void 0:null==(d=c.Ia)?void 0:d.sessionIndex;var h=vo({sessionIndex:e});if(!(h instanceof zf)){var k=new zf(Ja);Af(k,2,h);h=k}return u(g,h,2)}f=g.i;return g.return(Promise.resolve(Object.assign({},kq(b),f)))})}
function kq(a){var b={"Content-Type":"application/json"};L("enable_web_eom_visitor_data")&&B("EOM_VISITOR_DATA")?b["X-Goog-EOM-Visitor-Id"]=B("EOM_VISITOR_DATA"):B("VISITOR_DATA")&&(b["X-Goog-Visitor-Id"]=B("VISITOR_DATA"));"cors"!==a&&((a=B("INNERTUBE_CONTEXT_CLIENT_NAME"))&&(b["X-Youtube-Client-Name"]=a),(a=B("INNERTUBE_CONTEXT_CLIENT_VERSION"))&&(b["X-Youtube-Client-Version"]=a),(a=B("CHROME_CONNECTED_HEADER"))&&(b["X-Youtube-Chrome-Connected"]=a),L("forward_domain_admin_state_on_embeds")&&(a=
B("DOMAIN_ADMIN_STATE"))&&(b["X-Youtube-Domain-Admin-State"]=a));return b}
;var mq=["share/get_web_player_share_panel"],nq=["feedback"],oq=["notification/modify_channel_preference"],pq=["browse/edit_playlist"],qq=["subscription/subscribe"],rq=["subscription/unsubscribe"];function sq(){}
r(sq,No);sq.prototype.j=function(){return qq};
sq.prototype.h=function(a){return a.subscribeEndpoint};
sq.prototype.i=function(a,b,c){c=void 0===c?{}:c;b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params);c.botguardResponse&&(a.botguardResponse=c.botguardResponse);c.feature&&(a.clientFeature=c.feature)};
da.Object.defineProperties(sq.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function tq(){}
r(tq,No);tq.prototype.j=function(){return rq};
tq.prototype.h=function(a){return a.unsubscribeEndpoint};
tq.prototype.i=function(a,b){b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params)};
da.Object.defineProperties(tq.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function uq(){}
r(uq,No);uq.prototype.j=function(){return nq};
uq.prototype.h=function(a){return a.feedbackEndpoint};
uq.prototype.i=function(a,b,c){a.feedbackTokens=[];b.feedbackToken&&a.feedbackTokens.push(b.feedbackToken);if(b=b.cpn||c.cpn)a.feedbackContext={cpn:b};a.isFeedbackTokenUnencrypted=!!c.is_feedback_token_unencrypted;a.shouldMerge=!1;c.extra_feedback_tokens&&(a.shouldMerge=!0,a.feedbackTokens=a.feedbackTokens.concat(c.extra_feedback_tokens))};
da.Object.defineProperties(uq.prototype,{l:{configurable:!0,enumerable:!0,get:function(){return!0}}});function vq(){}
r(vq,No);vq.prototype.j=function(){return oq};
vq.prototype.h=function(a){return a.modifyChannelNotificationPreferenceEndpoint};
vq.prototype.i=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function wq(){}
r(wq,No);wq.prototype.j=function(){return pq};
wq.prototype.h=function(a){return a.playlistEditEndpoint};
wq.prototype.i=function(a,b){b.actions&&(a.actions=b.actions);b.params&&(a.params=b.params);b.playlistId&&(a.playlistId=b.playlistId)};function xq(){}
r(xq,No);xq.prototype.j=function(){return mq};
xq.prototype.h=function(a){return a.webPlayerShareEntityServiceEndpoint};
xq.prototype.i=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};function yq(){}
yq.prototype.fetch=function(a,b){var c=this,d,e,f;return w(function(g){if(1==g.h){d=new window.Request(a,b);if(L("web_fetch_promise_cleanup_killswitch"))return g.return(Promise.resolve(fetch(d).then(function(h){return c.handleResponse(h)}).catch(function(h){Gn(h)})));
ua(g,3);return u(g,fetch(d),5)}if(3!=g.h)return e=g.i,g.return(c.handleResponse(e));f=xa(g);Gn(f);return g.return(void 0)})};
yq.prototype.handleResponse=function(a){var b=a.text().then(function(c){return JSON.parse(c.replace(")]}'",""))});
a.redirected||a.ok||(b=b.then(function(c){Gn(new ok("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};var zq;function Aq(a){Ql.call(this,1,arguments);this.csn=a}
r(Aq,Ql);var Zl=new Rl("screen-created",Aq),Bq=[],Dq=Cq,Eq=0;function Fq(a,b,c,d,e,f,g){function h(){Gn(new ok("newScreen() parent element does not have a VE - rootVe",b))}
var k=Dq();f=new Qn({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,X:k};if(L("il_via_jspb")){var m=new xg;m.Y(k);yg(m,f.getAsJspb());c&&c.visualElement?(f=new zg,c.clientScreenNonce&&G(f,2,c.clientScreenNonce),Ag(f,c.visualElement.getAsJspb()),g&&G(f,4,wg[g]),H(m,5,f)):c&&h();d&&G(m,3,d);Rp(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=g)):
c&&h(),d&&(f.cloneCsn=d),a?sj("screenCreated",f,a,e):lk("screenCreated",f,e);Wl(Zl,new Aq(k));return k}
function Gq(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:Zn(b),
X:b};d=q(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(ob(g)||!g.trackingParams&&!g.veType)&&Gn(Error("Child VE logged with no data"));if(L("il_via_jspb")){var h=new Bg;h.Y(b);Dg(h,c.getAsJspb());fb(e,function(k){k=k.getAsJspb();Pc(h,3,vg,k)});
"UNDEFINED_CSN"==b?Hq("visualElementAttached",h,f):Sp(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:fb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?Hq("visualElementAttached",c,f):a?sj("visualElementAttached",c,a,f):lk("visualElementAttached",c,f)}
function Cq(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return zc(b,3)}
function Hq(a,b,c){Bq.push({payloadName:a,payload:b,options:c});Eq||(Eq=$l())}
function am(a){if(Bq){for(var b=q(Bq),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(L("il_via_jspb"))switch(c.payload.Y(a.csn),c.payloadName){case "screenCreated":Rp(c.payload,c.options);break;case "visualElementAttached":Sp(c.payload,c.options);break;case "visualElementShown":Np(c.payload,c.options);break;case "visualElementHidden":Op(c.payload,c.options);break;case "visualElementGestured":Pp(c.payload,c.options);break;case "visualElementStateChanged":Qp(c.payload,c.options);break;default:Gn(new ok("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,sj(c.payloadName,c.payload,null,c.options);Bq.length=0}Eq=0}
;function Iq(){this.i=new Set;this.h=new Set;this.j=new Map}
Iq.prototype.clear=function(){this.i.clear();this.h.clear();this.j.clear()};
Ka(Iq);function Jq(){this.o=[];this.D=[];this.h=[];this.l=[];this.m=[];this.i=new Set;this.u=new Map}
function Kq(a,b,c){c=void 0===c?0:c;b.then(function(d){a.i.has(c)&&a.j&&a.j();var e=Xn(c),f=Vn(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&Gq(a.client,e,f,[Rn(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&Gq(a.client,e,f,[Rn(d.playerResponse.trackingParams)])}})}
function Lq(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.o.push([b,c]);else{var e=Xn(d);c=c||Vn(d);e&&c&&Gq(a.client,e,c,[b])}}
Jq.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Xn(void 0===c?0:c)){a=this.client;var e=Rn(d);var f="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";d={cttAuthInfo:Zn(c),X:c};if(L("il_via_jspb")){var g=new Eg;g.Y(c);e=e.getAsJspb();H(g,2,e);G(g,4,wg[f]);b&&H(g,3,void 0);"UNDEFINED_CSN"==c?Hq("visualElementGestured",g,d):Pp(g,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:f},b&&(f.clientData=b),"UNDEFINED_CSN"==c?Hq("visualElementGestured",f,d):a?sj("visualElementGestured",
f,a,d):lk("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function Mq(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){Nq(a,b,c);var f=Vn(c.layer);if(f){for(var g=q(a.o),h=g.next();!h.done;h=g.next())h=h.value,Lq(a,h[0],h[1]||f,c.layer);f=q(a.D);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Xn(g);var m=k[0]||Vn(g);if(h&&m){g=a.client;var n=k[1];k={cttAuthInfo:Zn(h),X:h};L("il_via_jspb")?(n=new Gg,n.Y(h),m=m.getAsJspb(),H(n,2,m),"UNDEFINED_CSN"==h?Hq("visualElementStateChanged",n,k):Qp(n,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:n},"UNDEFINED_CSN"==h?Hq("visualElementStateChanged",m,k):g?sj("visualElementStateChanged",m,g,k):lk("visualElementStateChanged",m,k))}}}};
Xn(c.layer)||a.j();if(c.sb)for(var d=q(c.sb),e=d.next();!e.done;e=d.next())Kq(a,e.value,c.layer);else Fn(Error("Delayed screen needs a data promise."))}
function Nq(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ec?c.ec:c.layer;var e=Xn(d);d=Vn(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=B("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Fq(a.client,b,f,c.rb,c.cttAuthInfo,g,c.uo)}catch(m){Hn(m,{Ao:b,rootVe:d,parentVisualElement:void 0,ro:e,wo:f,rb:c.rb});Fn(m);return}$n(k,b,
c.layer,c.cttAuthInfo);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=L("screen_manager_skip_hide_killswitch"))){a:{b=q(Object.values(Pn));for(f=b.next();!f.done;f=b.next())if(Xn(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:Zn(e),X:e,ub:g},L("il_via_jspb")?(h=new Fg,h.Y(e),d=d.getAsJspb(),H(h,2,d),G(h,4,g?16:8),"UNDEFINED_CSN"==e?Hq("visualElementHidden",h,f):Op(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?Hq("visualElementHidden",
d,f):b?sj("visualElementHidden",d,b,f):lk("visualElementHidden",d,f)));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=k||"");$p({clientScreenNonce:k});Iq.getInstance().clear();d=Vn(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(L("web_mark_root_visible")||L("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:Zn(e),X:e},L("il_via_jspb")?(b=new Fg,b.Y(e),f=d.getAsJspb(),H(b,2,f),G(b,4,1),"UNDEFINED_CSN"==e?Hq("visualElementShown",b,k):Np(b,k,void 0)):(b={csn:e,ve:d.getAsJson(),eventType:1},
"UNDEFINED_CSN"==e?Hq("visualElementShown",b,k):lk("visualElementShown",b,k)));a.i.delete(c.layer||0);a.j=void 0;e=q(a.u);for(k=e.next();!k.done;k=e.next())b=q(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Lq(a,k,d,c.layer);for(c=0;c<a.l.length;c++){e=a.l[c];try{e()}catch(m){Fn(m)}}for(c=a.l.length=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Fn(m)}}}
;function Oq(){var a;return w(function(b){if(1==b.h)return u(b,hq(),2);if(a=b.i)return a.errorMetadata?(Fn(Error("Datasync IDs fetch responded with "+a.errorMetadata.code+": "+a.error)),b.return(void 0)):b.return(a.so);Gn(Error("Network request to get Datasync IDs failed."));return b.return(void 0)})}
;var Pq=x.caches,Qq;function Rq(a){var b=a.indexOf(":");return-1===b?{Cb:a}:{Cb:a.substring(0,b),datasyncId:a.substring(b+1)}}
function Sq(){return w(function(a){if(void 0!==Qq)return a.return(Qq);Qq=new Promise(function(b){var c;return w(function(d){switch(d.h){case 1:return ua(d,2),u(d,Pq.open("test-only"),4);case 4:return u(d,Pq.delete("test-only"),5);case 5:va(d,3);break;case 2:if(c=xa(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.h=0}})});
return a.return(Qq)})}
function Tq(a){var b,c,d,e,f,g,h;w(function(k){if(1==k.h)return u(k,Sq(),2);if(3!=k.h){if(!k.i)return k.return(!1);b=[];return u(k,Pq.keys(),3)}c=k.i;d=q(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=Rq(f),h=g.datasyncId,!h||a.includes(h)||b.push(Pq.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(n){return n})}))})}
;function Uq(){Oq().then(function(a){if(a&&(zl(a),Tq(a),L("clear_user_partitioned_ls"))){var b=void 0===b?{}:b;"_start"in dp("cupls")&&Z("aa",void 0,"cupls");var c=tp();c.cupls&&delete c.cupls;var d={timerName:"cupls",info:{},tick:{},span:{},jspbInfo:[]};rp().push(d);c.cupls=d;jp("cupls");bp();ip("cupls").useGel=!0;sp("cupls").info.actionType="cupls";b.cttAuthInfo&&(ip("cupls").cttAuthInfo=b.cttAuthInfo);jh("cuplsTIMING_ACTION","cupls");Z("_start",b.startTime,"cupls");b={actionType:Ap("cupls")};(c=
Xn())&&"UNDEFINED_CSN"!==c&&(b.clientScreenNonce=c);$p(b,"cupls");hp("cupls");Z("cuplss",void 0,"cupls");try{try{var e=!!self.localStorage}catch(t){e=!1}if(e)for(var f=Object.keys(window.localStorage),g=q(f),h=g.next();!h.done;h=g.next()){var k=h.value;var m=k.match(/(.*)::.*::.*/);var n=null!==m?m[1]:void 0;e=n;void 0===e||a.includes(e)||self.localStorage.removeItem(k)}Z("cuplsc",void 0,"cupls")}catch(t){Fn(t),Z("cuplse",void 0,"cupls")}}})}
function Vq(){var a=new Km;Rh.M(function(){a.G()?Uq():a.i.add("publicytnetworkstatus-online",Uq,!0,void 0,void 0)})}
;function Wq(a){a&&(a.dataset?a.dataset[Xq("loaded")]="true":a.setAttribute("data-loaded","true"))}
function Yq(a,b){return a?a.dataset?a.dataset[Xq(b)]:a.getAttribute("data-"+b):null}
var Zq={};function Xq(a){return Zq[a]||(Zq[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var $q=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,ar=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function br(a,b,c){c=void 0===c?null:c;if(window.spf&&spf.script){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace($q,""),c=c.replace(ar,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else cr(a,b,c)}
function cr(a,b,c){c=void 0===c?null:c;var d=dr(a),e=document.getElementById(d),f=e&&Yq(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Fi(d,b),b=""+Oa(b),er[b]=f),g||(e=fr(a,d,function(){Yq(e,"loaded")||(Wq(e),Ii(d),Hh(Va(Ji,d),0))},c)))}
function fr(a,b,c,d){d=void 0===d?null:d;var e=qd("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function gr(a){a=dr(a);var b=document.getElementById(a);b&&(Ji(a),b.parentNode.removeChild(b))}
function hr(a,b){a&&b&&(a=""+Oa(b),(a=er[a])&&Hi(a))}
function dr(a){var b=document.createElement("a");Qb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Vb(a)}
var er={};var ir=[],jr=!1;function kr(){if(!L("disable_biscotti_fetch_for_ad_blocker_detection")&&!L("disable_biscotti_fetch_entirely_for_all_web_clients")&&lo()&&"1"!=qb()){var a=function(){jr=!0;"google_ad_status"in window?jh("DCLKSTAT",1):jh("DCLKSTAT",2)};
try{br("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}ir.push(Rh.M(function(){if(!(jr||"google_ad_status"in window)){try{hr("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}jr=!0;jh("DCLKSTAT",3)}},5E3))}}
function lr(){var a=Number(B("DCLKSTAT",0));return isNaN(a)?0:a}
;function mr(){this.state=1;this.h=null}
l=mr.prototype;
l.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Ab("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=xb())?f.createScript(e):e,e=(new Cb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Ab("From proto message. b/166824318"),d=Gb(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());nr(this,e,
d,a.program,b,c)}else Gn(Error("Cannot initialize botguard without program"))};
function nr(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,br(c,function(){window[g]?or(a,d,g,e):(a.state=3,gr(c),Gn(new ok("Unable to load Botguard","from "+c)))},f)):b&&(f=qd("SCRIPT"),f.textContent=b,f.nonce=Tb(),document.head.appendChild(f),document.head.removeChild(f),window[g]?or(a,d,g,e):(a.state=4,Gn(Error("Unable to load Botguard from JS"))))}
l.isInitialized=function(){return!!this.h};
l.getState=function(){return this.state};
function or(a,b,c,d){a.state=5;if(L("use_bg_facade"))if(window[c])try{var e=new fd({program:b,globalName:c});e.vc.then(function(){a.state=6;d&&d(b)});
pr(a,e)}catch(k){k instanceof Error&&(a.state=7,Gn(k))}else a.state=7,Gn(Error("VM not loaded, cannot start"));else{var f,g,h;if(e=null!=(h=null==(f=window[c])?void 0:f.ad)?h:null==(g=window[c])?void 0:g.bg){try{pr(a,new e(b)),a.state=6}catch(k){a.state=7,k instanceof Error&&Gn(k)}d&&d(b)}else a.state=7,Gn(Error("Failed to finish initializing VM"))}}
l.invoke=function(a){a=void 0===a?{}:a;if(this.h){if(this.h.Jb)return this.h.Jb({qb:a});if(this.h.hot)return this.h.hot(void 0,void 0,a);if(this.h.invoke)return this.h.invoke(void 0,void 0,a);Gn(Error("VM has unknown interface"))}return null};
l.dispose=function(){pr(this,null);this.state=8};
function pr(a,b){Rd(a.h);a.h=b}
;var qr=new mr;function rr(){return qr.isInitialized()}
function sr(a){a=void 0===a?{}:a;return qr.invoke(a)}
;function tr(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?Qh():d;this.l=c;this.j=d;this.i=new ed;this.h=a;a={};c=q(this.h.entries());for(d=c.next();!d.done;a={va:a.va,Da:a.Da},d=c.next()){var e=q(d.value);d=e.next().value;e=e.next().value;a.Da=d;a.va=e;d=function(f){return function(){f.va.fb();b.h[f.Da].Ta=!0;b.h.every(function(g){return!0===g.Ta})&&b.i.resolve()}}(a);
e=Mh(d,ur(this,a.va));this.h[a.Da]=Object.assign({},a.va,{fb:d,Oa:e})}}
function vr(a){var b=Array.from(a.h.keys()).sort(function(d,e){return ur(a,a.h[e])-ur(a,a.h[d])});
b=q(b);for(var c=b.next();!c.done;c=b.next())c=a.h[c.value],void 0===c.Oa||c.Ta||(a.j.U(c.Oa),Mh(c.fb,10))}
tr.prototype.cancel=function(){for(var a=q(this.h),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.Oa||b.Ta||this.j.U(b.Oa),b.Ta=!0;this.i.resolve()};
function ur(a,b){var c;return null!=(c=b.priority)?c:a.l}
;function wr(a){this.state=a;this.plugins=[];this.m=void 0}
wr.prototype.install=function(){this.plugins.push.apply(this.plugins,fa(Ga.apply(0,arguments)))};
wr.prototype.transition=function(a,b){var c=this,d=this.D.find(function(f){return f.from===c.state&&f.C===a});
if(d){this.j&&(vr(this.j),this.j=void 0);this.state=a;d=d.action.bind(this);var e=this.plugins.filter(function(f){return f[a]}).map(function(f){return f[a]});
d(xr(this,e,this.m),b)}else throw Error("no transition specified from "+this.state+" to "+a);};
function xr(a,b,c){return function(){var d=Ga.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
r(yr,wr);yr.prototype.u=function(a,b){if(!this.h.get("document_disposed_preventable")&&(a(b),(null==b?0:b.defaultPrevented)||(null==b?0:b.returnValue))){b.returnValue||(b.returnValue=!0);b.defaultPrevented||b.preventDefault();this.h=new Map;this.transition("document_active");return}this.h.set("document_disposed_preventable",!0);this.h.get("document_disposed")?this.transition("flush_logs"):this.transition("document_disposed")};
yr.prototype.l=function(a,b){this.h.get("document_disposed")?this.transition("document_active"):(a(b),this.h.set("document_disposed",!0),this.transition("flush_logs"))};
yr.prototype.o=function(a,b){a(b);this.transition("document_active")};
yr.prototype.i=function(){this.h=new Map};function zr(a){wr.call(this,void 0===a?"document_visibility_unknown":a);var b=this;this.D=[{from:"document_visibility_unknown",C:"document_visible",action:this.i},{from:"document_visibility_unknown",C:"document_hidden",action:this.h},{from:"document_visibility_unknown",C:"document_foregrounded",action:this.o},{from:"document_visibility_unknown",C:"document_backgrounded",action:this.l},{from:"document_visible",C:"document_hidden",action:this.h},{from:"document_visible",C:"document_foregrounded",action:this.o},
...
r(zr,wr);zr.prototype.i=function(a,b){a(b);L("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
zr.prototype.h=function(a,b){a(b);L("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
zr.prototype.l=function(a,b){a(b)};
zr.prototype.o=function(a,b){a(b)};function Ar(){this.h=new yr;this.i=new zr}
Ar.prototype.install=function(){var a=Ga.apply(0,arguments);this.h.install.apply(this.h,fa(a));this.i.install.apply(this.i,fa(a))};function Br(){Ar.call(this);var a={};this.install((a.document_disposed={la:this.j},a));a={};this.install((a.flush_logs={la:this.l},a))}
var Cr;r(Br,Ar);Br.prototype.l=function(){lk("finalPayload",{csn:Xn()})};
Br.prototype.j=function(){Jn(Kn)};function Dr(){}
Dr.getInstance=function(){var a=A("ytglobal.storage_");a||(a=new Dr,y("ytglobal.storage_",a,void 0));return a};
Dr.prototype.estimate=function(){var a,b,c;return w(function(d){a=navigator;return(null==(b=a.storage)?0:b.estimate)?d.return(a.storage.estimate()):(null==(c=a.webkitTemporaryStorage)?0:c.queryUsageAndQuota)?d.return(Er()):d.return()})};
function Er(){var a=navigator;return new Promise(function(b,c){var d;null!=(d=a.webkitTemporaryStorage)&&d.queryUsageAndQuota?a.webkitTemporaryStorage.queryUsageAndQuota(function(e,f){b({usage:e,quota:f})},function(e){c(e)}):c(Error("webkitTemporaryStorage is not supported."))})}
y("ytglobal.storageClass_",Dr,void 0);function jk(a,b){var c=this;this.handleError=a;this.h=b;this.i=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.i=!0});
this.j=Math.random()<=mh("ytidb_transaction_ended_event_rate_limit",.02)}
jk.prototype.logEvent=function(a,b){switch(a){case "IDB_DATA_CORRUPTED":L("idb_data_corrupted_killswitch")||this.h("idbDataCorrupted",b);break;case "IDB_UNEXPECTEDLY_CLOSED":this.h("idbUnexpectedlyClosed",b);break;case "IS_SUPPORTED_COMPLETED":L("idb_is_supported_completed_killswitch")||this.h("idbIsSupportedCompleted",b);break;case "QUOTA_EXCEEDED":Fr(this,b);break;case "TRANSACTION_ENDED":this.j&&this.h("idbTransactionEnded",b);break;case "TRANSACTION_UNEXPECTEDLY_ABORTED":a=Object.assign({},b,
{hasWindowUnloaded:this.i}),this.h("idbTransactionAborted",a)}};
function Fr(a,b){Dr.getInstance().estimate().then(function(c){c=Object.assign({},b,{isSw:void 0===self.document,isIframe:self!==self.top,deviceStorageUsageMbytes:Gr(null==c?void 0:c.usage),deviceStorageQuotaMbytes:Gr(null==c?void 0:c.quota)});a.h("idbQuotaExceeded",c)})}
function Gr(a){return"undefined"===typeof a?"-1":String(Math.ceil(a/1048576))}
;var Hr=window;
function Ir(){var a=Hr.uaChPolyfill.state;if(0===a.type)lk("clientHintsPolyfillEvent",{clientHintsSupported:!1});else{var b=navigator.userAgent,c=void 0!==a.syntheticUa&&a.syntheticUa===b,d={clientHintsSupported:!0,uaAccessedBeforePolyfill:a.didAccessUaBeforePolyfillAvailable,syntheticUaMatches:c};a.didAccessUaBeforePolyfillAvailable&&(d.uaAccessBeforePolyfillCount=a.uaAccessBeforePolyfillCount,a.firstAccessUaError&&(d.firstUaAccessStack=String(a.firstAccessUaError.stack).replace(/\n/g,""),Fn(a.firstAccessUaError)),
...
b))}}
var Jr=!1;function Kr(){var a;1===(null==(a=Hr.uaChPolyfill)?void 0:a.state.type)?Jr||(Hr.uaChPolyfill.onReady=Kr,Jr=!0):Hr.uaChPolyfill&&Ir()}
;function Lr(a,b,c){J.call(this);var d=this;c=c||B("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.K="*";this.l=c;this.sessionId=null;this.channel="widget";this.L=!!a;this.A=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.L&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(Lr,J);Lr.prototype.sendMessage=function(a,b){if(b=b||this.j){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.K)}catch(d){xh(d)}}};
Lr.prototype.H=function(){window.removeEventListener("message",this.A);J.prototype.H.call(this)};function Mr(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new Lr(!!B("WIDGET_ID_ENFORCE")),b=this.hc.bind(this);a.m=b;a.u=null;this.h.channel="widget";if(a=B("WIDGET_ID"))this.h.sessionId=a}
l=Mr.prototype;l.hc=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,Nr(this,a)),this.j[a]=!0)):this.lb(a,b,c)};
l.lb=function(){};
function Nr(a,b){return function(c){return a.sendMessage(b,c)}}
...
function Or(a,b){a.sendMessage("infoDelivery",b)}
...
l.dispose=function(){this.h=null};function Pr(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Qr(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function Rr(a,b,c,d){if(Na(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Sr(a){Mr.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.sc.bind(this));this.addEventListener("onVolumeChange",this.tc.bind(this));this.addEventListener("onApiChange",this.lc.bind(this));this.addEventListener("onPlaybackQualityChange",this.oc.bind(this));this.addEventListener("onPlaybackRateChange",this.pc.bind(this));this.addEventListener("onStateChange",this.qc.bind(this));this.addEventListener("onWebglSettingsChanged",
this.uc.bind(this))}
r(Sr,Mr);l=Sr.prototype;
l.lb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Pr(a)){var d=b;if(Na(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Qr(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=Qr(e);break;case "loadPlaylist":case "cuePlaylist":e=Rr(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);Pr(a)&&Or(this,this.Za())}};
...
(a.videoUrl=this.api.getVideoUrl());this.api.getVideoContentRect&&(a.videoContentRect=this.api.getVideoContentRect());this.api.getProgressState&&(a.progressState=this.api.getProgressState());this.api.getPlaylist&&(a.playlist=this.api.getPlaylist());this.api.getPlaylistIndex&&(a.playlistIndex=this.api.getPlaylistIndex());this.api.getStoryboardFormat&&(a.storyboardFormat=this.api.getStoryboardFormat());Or(this,a)};
l.oc=function(a){Or(this,{playbackQuality:a})};
l.pc=function(a){Or(this,{playbackRate:a})};
...
l.tc=function(){Or(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
l.sc=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());Or(this,a)};
l.uc=function(){var a={sphericalProperties:this.api.getSphericalProperties()};Or(this,a)};
l.dispose=function(){Mr.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Tr(a){J.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Eb,this)}
r(Tr,J);l=Tr.prototype;l.start=function(){this.started||this.h()||(this.started=!0,this.connection.na("RECEIVING"))};
l.na=function(a,b){this.started&&!this.h()&&this.connection.na(a,b)};
l.Eb=function(a,b,c){if(this.started&&!this.h()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=Ur(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=Vr(a,c))&&this.na(a,c))}}};
...
l.H=function(){var a=this.connection;a.h()||Rf(a.i,"command",this.Eb,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);J.prototype.H.call(this)};function Wr(a,b){Tr.call(this,b);this.api=a;this.start()}
r(Wr,Tr);Wr.prototype.addEventListener=function(a,b){this.api.addEventListener(a,b)};
Wr.prototype.removeEventListener=function(a,b){this.api.removeEventListener(a,b)};
function Ur(a,b){switch(a){case "loadVideoById":return a=Qr(b),[a];case "cueVideoById":return a=Qr(b),[a];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return a=Rr(b),[a];case "cuePlaylist":return a=Rr(b),[a];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
case "setShuffle":return[b.shufflePlaylist];case "getOptions":return[b.module];case "getOption":return[b.module,b.option];case "setOption":return[b.module,b.option,b.value];case "handleGlobalKeyDown":return[b.keyCode,b.shiftKey,b.ctrlKey,b.altKey,b.metaKey,b.key,b.code]}return[]}
function Vr(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
Wr.prototype.Ya=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Tr.prototype.Ya.call(this,a,b)};
Wr.prototype.H=function(){Tr.prototype.H.call(this);delete this.api};function Xr(a){a=void 0===a?!1:a;J.call(this);this.i=new K(a);Td(this,Va(Rd,this.i))}
Xa(Xr,J);Xr.prototype.subscribe=function(a,b,c){return this.h()?0:this.i.subscribe(a,b,c)};
Xr.prototype.l=function(a,b){this.h()||this.i.ka.apply(this.i,arguments)};function Yr(a,b,c){Xr.call(this);this.j=a;this.destination=b;this.id=c}
r(Yr,Xr);Yr.prototype.na=function(a,b){this.h()||this.j.na(this.destination,this.id,a,b)};
Yr.prototype.H=function(){this.destination=this.j=null;Xr.prototype.H.call(this)};function Zr(a,b,c){J.call(this);this.destination=a;this.origin=c;this.i=Eh(window,"message",this.j.bind(this));this.connection=new Yr(this,a,b);Td(this,Va(Rd,this.connection))}
r(Zr,J);Zr.prototype.na=function(a,b,c,d){this.h()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(sf(a),this.origin))};
Zr.prototype.j=function(a){var b;if(b=!this.h())if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h()||c.l("command",b.command,b.data,a.origin))}};
Zr.prototype.H=function(){Fh(this.i);this.destination=null;J.prototype.H.call(this)};function $r(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||sb(b);this.assets=a.assets||{};this.attrs=a.attrs||sb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
$r.prototype.clone=function(){var a=new $r,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==La(c)?a[b]=sb(c):a[b]=c}return a};var as=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function bs(a){a=a||"";if(window.spf){var b=a.match(as);spf.style.load(a,b?b[1]:"",void 0)}else cs(a)}
function cs(a){var b=ds(a),c=document.getElementById(b),d=c&&Yq(c,"loaded");d||c&&!d||(c=es(a,b,function(){Yq(c,"loaded")||(Wq(c),Ii(b),Hh(Va(Ji,b),0))}))}
function es(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=qf(a);Rb(d,a);(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function ds(a){var b=qd("A");Ab("This URL is never added to the DOM");Qb(b,new Ib(a,Jb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Vb(a)}
;function fs(){J.call(this);this.i=[]}
r(fs,J);fs.prototype.H=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.la,void 0)}J.prototype.H.call(this)};function gs(){fs.apply(this,arguments)}
r(gs,fs);function hs(a,b,c,d){J.call(this);var e=this;this.L=b;this.webPlayerContextConfig=d;this.Va=!1;this.api={};this.Fa=this.u=null;this.S=new K;this.i={};this.ga=this.Ga=this.elementId=this.Wa=this.config=null;this.Z=!1;this.l=this.A=null;this.Ha={};this.Mb=["onReady"];this.lastError=null;this.mb=NaN;this.K={};this.Nb=new gs(this);this.qa=0;this.j=this.m=a;Td(this,Va(Rd,this.S));is(this);js(this);Td(this,Va(Rd,this.Nb));c?this.qa=Hh(function(){e.loadNewVideoConfig(c)},0):d&&(ks(this),ls(this))}
r(hs,J);l=hs.prototype;l.getId=function(){return this.L};
l.loadNewVideoConfig=function(a){if(!this.h()){this.qa&&(Ih(this.qa),this.qa=0);var b=a||{};b instanceof $r||(b=new $r(b));this.config=b;this.setConfig(a);ls(this);this.isReady()&&ms(this)}};
function ks(a){var b;a.webPlayerContextConfig?b=a.webPlayerContextConfig.rootElementId:b=a.config.attrs.id;a.elementId=b||a.elementId;"video-player"===a.elementId&&(a.elementId=a.L,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.L:a.config.attrs.id=a.L);var c;(null==(c=a.j)?void 0:c.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
l.setConfig=function(a){this.Wa=a;this.config=ns(a);ks(this);if(!this.Ga){var b;this.Ga=os(this,(null==(b=this.config.args)?void 0:b.jsapicallback)||"onYouTubePlayerReady")}this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null==(c=this.config)?0:c.attrs)a=this.config.attrs,(b=a.width)&&this.j&&(this.j.style.width=Bd(Number(b)||b)),(a=a.height)&&this.j&&(this.j.style.height=Bd(Number(a)||a))};
function ms(a){if(a.config&&!0!==a.config.loaded)if(a.config.loaded=!0,!a.config.args||"0"!==a.config.args.autoplay&&0!==a.config.args.autoplay&&!1!==a.config.args.autoplay){var b;a.api.loadVideoByPlayerVars(null!=(b=a.config.args)?b:null)}else a.api.cueVideoByPlayerVars(a.config.args)}
function ps(a){var b=!0,c=qs(a);c&&a.config&&(a=rs(a),b=Yq(c,"version")===a);return b&&!!A("yt.player.Application.create")}
function ls(a){if(!a.h()&&!a.Z){var b=ps(a);if(b&&"html5"===(qs(a)?"html5":null))a.ga="html5",a.isReady()||ss(a);else if(ts(a),a.ga="html5",b&&a.l&&a.m)a.m.appendChild(a.l),ss(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=us(a,"player_bootstrap_method")?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.config?ns(a.config):void 0;d&&d(a.m,e,a.webPlayerContextConfig);ss(a)};
a.Z=!0;b?a.A():(br(rs(a),a.A),(b=vs(a))&&bs(b),ws(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function qs(a){var b=pd(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function ss(a){if(!a.h()){var b=qs(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.Z=!1;if(!us(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}xs(a)}else a.mb=Hh(function(){ss(a)},50)}}
function xs(a){is(a);a.Va=!0;var b=qs(a);if(b){a.u=ys(a,b,"addEventListener");a.Fa=ys(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=ys(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.u&&a.u(g,a.i[g]);ms(a);a.Ga&&a.Ga(a.api);a.S.ka("onReady",a.api)}
function ys(a,b,c){var d=b[c];return function(){var e=Ga.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Gn(f))}}}
function is(a){a.Va=!1;if(a.Fa)for(var b in a.i)a.i.hasOwnProperty(b)&&a.Fa(b,a.i[b]);for(var c in a.K)a.K.hasOwnProperty(c)&&Ih(Number(c));a.K={};a.u=null;a.Fa=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function js(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Ii("WATCH_LATER_VIDEO_ADDED",b)});
...
l.addEventListener=function(a,b){var c=this,d=os(this,b);d&&(0<=cb(this.Mb,a)||this.i[a]||(b=zs(this,a),this.u&&this.u(a,b)),this.S.subscribe(a,d),"onReady"===a&&this.isReady()&&Hh(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.h()||(b=os(this,b))&&Rf(this.S,a,b)};
function os(a,b){var c=b;if("string"===typeof b){if(a.Ha[b])return a.Ha[b];c=function(){var d=Ga.apply(0,arguments),e=A(b);if(e)try{e.apply(x,d)}catch(f){Fn(f)}};
a.Ha[b]=c}return c?c:null}
function zs(a,b){var c="ytPlayer"+b+a.L;a.i[b]=c;x[c]=function(d){var e=Hh(function(){if(!a.h()){a.S.ka(b,null!=d?d:void 0);var f=a.K,g=String(e);g in f&&delete f[g]}},0);
pb(a.K,String(e))};
return c}
l.getPlayerType=function(){return this.ga||(qs(this)?"html5":null)};
l.getLastError=function(){return this.lastError};
function ts(a){a.cancel();is(a);a.ga=null;a.config&&(a.config.loaded=!1);var b=qs(a);b&&(ps(a)||!ws(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.m)for(a=a.m;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.A&&hr(rs(this),this.A);Ih(this.mb);this.Z=!1};
l.H=function(){ts(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){Fn(b)}this.Ha=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(x[this.i[a]]=null);this.Wa=this.config=this.api=null;delete this.m;delete this.j;J.prototype.H.call(this)};
function ws(a){var b,c;a=null==(b=a.config)?void 0:null==(c=b.args)?void 0:c.fflags;return!!a&&-1!==a.indexOf("player_destroy_old_version=true")}
function rs(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.jsUrl:(a=a.config.assets)?a.js:""}
function vs(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.cssUrl:(a=a.config.assets)?a.css:""}
function us(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===bi(c||"","&")[b]}
function ns(a){for(var b={},c=q(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?sb(e):e}return b}
;var As={},Bs="player_uid_"+(1E9*Math.random()>>>0);function Cs(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?pd(d):d;var e=Bs+"_"+Oa(d),f=As[e];if(f&&c)return Ds(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new hs(d,e,a,b);As[e]=f;Ii("player-added",f.api);Td(f,function(){delete As[f.getId()]});
return f.api}
function Ds(a,b){return b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags?a.args.fflags.includes("web_player_remove_playerproxy=true"):!1}
;var Es=null,Fs=null,Gs=null;function Hs(){var a=Es.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
;function Is(a,b,c){a="ST-"+Vb(a).toString(36);b=b?ac(b):"";c=c||5;lo()&&xj(a,b,c)}
;function Js(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=B("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=B("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Yb(window.location.href);g&&f.push(g);g=Yb(d);if(0<=cb(f,g)||!g&&0==d.lastIndexOf("/",0))if(L("autoescape_tempdata_url")&&(f=document.createElement("a"),Qb(f,d),d=f.href),d&&(d=Zb(d),f=d.indexOf("#"),d=0>f?d:d.substr(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:Xn()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
Is(d,b,h)}else Is(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var n=void 0===n?window:n;c=n.location;a=bc(a,k)+m;var t=void 0===t?Ad:t;a:{t=void 0===t?Ad:t;for(k=0;k<t.length;++k)if(m=t[k],m instanceof yd&&m.isValid(a)){t=new jd(a,hd);break a}t=void 0}c.href=ld(t||kd)}return!0}
;y("yt.setConfig",jh,void 0);y("yt.config.set",jh,void 0);y("yt.setMsg",bo,void 0);y("yt.msgs.set",bo,void 0);y("yt.logging.errors.log",Fn,void 0);
y("writeEmbed",function(){var a=B("PLAYER_CONFIG",void 0);if(!a){var b=B("PLAYER_VARS",void 0);b&&(a={args:b})}to(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=B("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);L("embeds_js_api_set_1p_cookie")&&(c=gi(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));Xp();
if((c=B("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=gi(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Es=Cs(a,c,!1)}else Es=Cs(a);Es.addEventListener("onVideoDataChange",Hs);a=B("POST_MESSAGE_ID","player");B("ENABLE_JS_API")?Gs=new Sr(Es):B("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Fs=new Zr(window.parent,
a,b),Gs=new Wr(Es,Fs.connection));kr();L("ytidb_create_logger_embed_killswitch")||ik();L("flush_gel_on_teardown")&&(a={},Cr||(Cr=new Br),Cr.install((a.flush_logs={la:function(){aj()}},a)));
L("networkless_logging_web_embedded")&&(L("embeds_web_enable_new_nwl")?Qm():Ym());L("embeds_enable_ua_ch_polyfill")&&Kr();L("ytidb_clear_embedded_player")&&Rh.M(function(){if(!zq){var e={pb:{feedbackEndpoint:Io(uq),modifyChannelNotificationPreferenceEndpoint:Io(vq),playlistEditEndpoint:Io(wq),subscribeEndpoint:Io(sq),unsubscribeEndpoint:Io(tq),webPlayerShareEntityServiceEndpoint:Io(xq)}},f=L("web_enable_client_location_service")?Eo.getInstance():void 0,g=[],h={};f&&(g.push(f),h.client_location=f);
if(void 0===k){uo.h||(uo.h=new uo);var k=uo.h}if(void 0===m){yq.h||(yq.h=new yq);var m=yq.h}gq(e,m,k,g,h);zq=fq.h}Vq()})},void 0);
var Ks=vh(function(){cq();var a=Bj.getInstance(),b=Ej(119),c=1<window.devicePixelRatio;if(document.body&&$e(document.body,"exp-invert-logo"))if(c&&!$e(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!$e(d,"inverted-hdpi")){var e=Ye(d);Ze(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&$e(document.body,"inverted-hdpi")&&af();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Fj(b)||0;d=c?d|67108864:d&-67108865;0==d?delete Aj[b]:(c=d.toString(16),
Aj[b]=c.toString());c=!0;L("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in Aj)d.push(f+"="+encodeURIComponent(String(Aj[f])));xj(b,d.join("&"),63072E3,a.i,c)}Jq.h||(Jq.h=new Jq);a=Jq.h;f=16623;var g=void 0===g?{}:g;Object.values(co).includes(f)||(Gn(new ok("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.o=[];a.D=[];g.sb?Mq(a,f,g):Nq(a,f,g)}),Ls=vh(function(){Es&&Es.sendAbandonmentPing&&Es.sendAbandonmentPing();
B("PL_ATT")&&qr.dispose();for(var a=0,b=ir.length;a<b;a++)Rh.U(ir[a]);ir.length=0;gr("//static.doubleclick.net/instream/ad_status.js");jr=!1;jh("DCLKSTAT",0);Sd(Gs,Fs);Es&&(Es.removeEventListener("onVideoDataChange",Hs),Es.destroy())});
window.addEventListener?(window.addEventListener("load",Ks),window.addEventListener("unload",Ls)):window.attachEvent&&(window.attachEvent("onload",Ks),window.attachEvent("onunload",Ls));Wa("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||rr);Wa("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||sr);Wa("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||lr);
Wa("yt.player.exports.navigate",A("yt.player.exports.navigate")||Js);Wa("yt.util.activity.init",A("yt.util.activity.init")||Th);Wa("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||Wh);Wa("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||Uh);}).call(this);
